 ...
 *
 * $Id: UML2ActionBarContributor.java,v 1.1 2009-03-04 23:08:38 andrew Exp $
 */
 ...
 * @generated
 */
public class UML2ActionBarContributor
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		//
		createChildMenuManager = new MenuManager(UML2EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(UML2EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
