...
// provided ports
	private IAnalyserAnalyserImpl analyser_IAnalyserProvided = new IAnalyserAnalyserImpl();
// setters and getters
	public void setEvents_IEventManager(lts.IEventManager events) { this.events = events; }
	public lts.IAnalyser getAnalyser_IAnalyser(Class<?> required) { return analyser_IAnalyserProvided; }
// end generated code
	...
	private class IAnalyserAnalyserImpl implements IAnalyser, IAnimator
	{
	...
	// action name chosen - only valid after a step
		...
		private CompactState private_compose(boolean dohiding) {
			...
			CompactState c = new CompactState(stateCount, cs.name, analysed,
