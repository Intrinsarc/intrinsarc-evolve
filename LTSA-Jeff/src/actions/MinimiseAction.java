...
// attributes
	...
	private Attribute<java.lang.String> name = new Attribute<java.lang.String>("Minimise");
	private Attribute<java.lang.String> icon = new Attribute<java.lang.String>("icon/minimize.gif");
// required ports
	...
	private class IActionActionImpl implements actions.IAction
	{
		...
		public boolean doAction() {
			...
			if (coordinator.needRecompile())
					compiler.doAction();
			if (top.get() != null) {
				if (top.get().composition == null)
					top.get().compose(inout_LTSOutputRequired);
				top.get().minimise(inout_LTSOutputRequired);
				if (events != null)
