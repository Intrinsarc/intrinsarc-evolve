 ...
 * 
 * @author tonyj
 * @version $Id: AboutDialog.java,v 1.1 2009-03-04 22:46:56 andrew Exp $
 */
public class AboutDialog extends javax.swing.JDialog
{
   ...
   * 
   * @param app
   *          The application owning the AboutDialog
   */
  ...
  protected class InfoPanel extends JPanel implements java.awt.event.ActionListener
  {
    ...
    public void actionPerformed(java.awt.event.ActionEvent e)
    {
      ...
      if (source == b1)
        ...
        if (source == b2)
          prop = app.getAppProperties();
        else
          prop = app.getUserProperties();

      javax.swing.JTable table = new javax.swing.JTable(new org.freehep.application.PropertyUtilities.PropertyTable(
          prop));
