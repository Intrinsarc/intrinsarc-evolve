 ...
 * @version $Id: PluginInstallDialog.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 */
...
class PluginInstallDialog extends JDialog implements ListSelectionListener, ActionListener
{
  ...
  public void valueChanged(ListSelectionEvent e)
  {
    ...
    if (index >= 0)
      info.setPlugin((PluginInfo) plugins.get(index));
    else
      info.setPlugin(null);
  }
  ...
  private class DataModel extends AbstractTableModel
  {
    ...
    {
      if (columnIndex == 0)
        return new Boolean(onOff.get(rowIndex));
      else
        return ((PluginInfo) plugins.get(rowIndex)).getName();
    }
    ...
    {
      return columnIndex == 0 ? (Class) Boolean.class : (Class) String.class;
    }
