 ...
 *
 * Version $Id: ChainableRecordListenerDecorator.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 *
...
/**
 * This class decorates an <code>{@link RecordListener}</code> object so that
 * the methods of another <code>RecordListener</code> object are executed in
 * succession to its own method, thus creating a chain of listeners.
 * 
 * @version $Id: ChainableRecordListenerDecorator.java,v 1.1 2006-07-03 13:32:14
 *          amcveigh Exp $
 * @author patton
 */
public class ChainableRecordListenerDecorator extends ChainableRecordAdapter
{
   ...
   *           if the listener is new and has not been handed at least on record
   *           already.
   */
