 ...
 * class: RecordEvent
 *
 * Version $Id: RecordEvent.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 *
...
public class RecordEvent extends EventObject
{
   ...
   * 
   * @param source
   *          the object which is the source of this event.
   */
  ...
  /**
   * Returns the SequentialRecordLoop which is the source of this event. If the
   * source of this event is not a SequentialRecordLoop object then 'null' is
   * returned.
   * 
