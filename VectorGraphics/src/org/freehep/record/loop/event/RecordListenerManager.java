 ...
 *
 * Version $Id: RecordListenerManager.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 *
 * Date: March 7 2003
 *
...
/**
 * This interface should be implemented by any class that can register single
 * <code>{@link RecordListener}</code> objects.
 * 
 * @version $Id: RecordListenerManager.java,v 1.1 2006-07-03 13:32:14 amcveigh
 *          Exp $
 * @author patton
 */
public interface RecordListenerManager
{
   ...
   *           if a listener is already present.
