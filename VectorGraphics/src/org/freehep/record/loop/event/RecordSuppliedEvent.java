 ...
 *
 * Version $Id: RecordSuppliedEvent.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 *
...
public class RecordSuppliedEvent extends RecordEvent
{
  ...
  /**
   * Create an instance of this class with the specified record as the source
   * and specified record.
   * 
   * @param source
   *          the SequentialRecordLoop record which generated this event.
   * @param record
   *          the new record that was supplied.
   */
  public RecordSuppliedEvent(Object source, Object record)
  {
    super(source);
    this.record = record;
  }
   ...
   *          the new record that was supplied.
   */
  public RecordSuppliedEvent(SequentialRecordLoop source, Object object)
  {
    super(source);
    this.record = object;
  }
