 ...
 *
 * Version $Id: ChainableRecordAdapter.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 *
...
/**
 * This class implements the <code>ChainableRecordListener</code> interface so
 * that the methods of another <code>RecordListener</code> object are
 * correctly executed in succession to its own processing, thus creating a chain
 * of listeners. To function correctly any standard <code>RecordListener</code>
 * event method which is overridden should, as its last step, call this classes
 * implementation of that method. For example:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * @version $Id: ChainableRecordAdapter.java,v 1.1 2006-07-03 13:32:14 amcveigh
 *          Exp $
 * @author patton
 */
class ChainableRecordAdapter implements ChainableRecordListener
{
  ...
  /**
   * Returns the RecordListener which is executed after this object. null is
   * returned if no listener succeeds this object listener.
   * 
   ...
   *           if the listener is new and has not been handed at least one
   *           record already.
   */
