 ...
 * class: LoopEvent
 *
 * Version $Id: LoopProgressEvent.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 *
 * Date: March 7 2003
 *
...
/**
 * This class is used to update {@link RecordLoopListener} objects on the
 * progress of a <code>{@link
...
public class LoopProgressEvent extends EventObject
{
   ...
   *          the fraction of a loop that has been completed.
   */
  public LoopProgressEvent(Object source, double fraction)
  {
    super(source);
