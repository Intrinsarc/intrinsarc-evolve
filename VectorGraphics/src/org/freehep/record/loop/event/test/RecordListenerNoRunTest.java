 ...
 *
 * Version $Id: RecordListenerNoRunTest.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 *
 ...
 * 
 * @version $Id: RecordListenerNoRunTest.java,v 1.1 2006-07-03 13:32:54 amcveigh
 *          Exp $
 * @author patton
 */
public abstract class RecordListenerNoRunTest extends TestCase
{
  ...
  /**
   * @return the configuration object for any configure or reconfigure message.
   */
  ...
  /**
   * @param the
   *          configuration object for a configure or reconfigure transition.
   */
  ...
  /**
   * @param the
   *          record for any recordSuppiled transition.
   */
  ...
  public void testConfigureFromReady()
  {
    ...
    testObject.configure(new ConfigurationEvent(this, configuration));
  }
  ...
  public void testProcessingFromConfigured()
  {
    ...
    testObject.recordSupplied(new RecordSuppliedEvent(this, record));
  }
  ...
  public void testReconfigureFromSuspended()
  {
    ...
    testObject.reconfigure(new ConfigurationEvent(this, configuration));
  }
