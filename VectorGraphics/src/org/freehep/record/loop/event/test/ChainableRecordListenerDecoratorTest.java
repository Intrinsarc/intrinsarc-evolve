 ...
 *
 * Version $Id: ChainableRecordListenerDecoratorTest.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 *
 ...
 * pass.
 * 
 * @version $Id: ChainableRecordListenerDecoratorTest.java,v 1.1 2006-07-03
 *          13:32:54 amcveigh Exp $
 * @author patton
 */
public class ChainableRecordListenerDecoratorTest extends RecordListenerNoRunTest
{
  ...
  private class MockListener implements RecordListener
  {
    private int id;
    private int precedingId;

    public MockListener(int id, int precedingId)
    {
      this.id = id;
    ...
    {
      Assert.assertEquals(lastId, precedingId);
      Assert.assertEquals(TEST_RECORD, event.getRecord());
      lastId = id;
    }
