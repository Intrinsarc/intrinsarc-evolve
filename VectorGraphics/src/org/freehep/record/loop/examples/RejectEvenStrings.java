 ...
 *
 * Version $Id: RejectEvenStrings.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 *
 ...
 * objects can be used to do conditional processing of events by rejecting
 * certain records that are supplied. This example uses the listener in the
 * EchoStrings example, but this listener is chained behind an instance of this
 * class which is an <code>RecordListener</code> that can reject, if
 * specified, every other record with which is suppiled to it.
 * 
 * @version $Id: RejectEvenStrings.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 * @author patton
 */
public class RejectEvenStrings extends RecordAdapter
{
  ...
  public static void main(String args[]) throws FileNotFoundException
  {
    ...
    ChainableRecordListener listener = new ChainableRecordListenerDecorator(rejectEvenStrings);
    try
    {
