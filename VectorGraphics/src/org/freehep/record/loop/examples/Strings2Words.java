 ...
 *
 * Version $Id: Strings2Words.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 *
 ...
 * object. This example uses the listener in the EchoStrings example, but this
 * listener is chained behind an instance of this class which is an
 * <code>RecordListener</code> that replaces the Strings in the record with a
 * new set of strings containing the individual words from the original strings.
 * Thus the EchoStrings listener will output one word on each line, rather than
 * a line at a time.
 * 
 * @version $Id: Strings2Words.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 * @author patton
 */
public class Strings2Words extends RecordAdapter
{
  ...
  public static void main(String args[]) throws FileNotFoundException
  {
    ...
    ChainableRecordListener listener = new ChainableRecordListenerDecorator(echoWords);
    try
    {
    ...
    SequentialRecordSource supplier = echoStrings.new LineSupplier(args[0]);

    // Create basic event loop
    SequentialRecordLoop recordLoop = new SequentialRecordLoopImpl(supplier);
    try
    {
