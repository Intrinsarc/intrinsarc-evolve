 ...
 * class: EchoStrings
 *
 * Version $Id: EchoStrings.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 *
 ...
 * org.freehep.record.loop} package can be used. It implements, as a nested
 * class, a <code>SequentialRecordSource</code> that reads a file and supplys
 * each line read as a record. The class itself implements a
 * <code>RecordListener</code> that prints the contents of each record, with
 * which it is supplied, to the standard output.
 * 
 * @version $Id: EchoStrings.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 * @author patton
 */
public class EchoStrings extends RecordAdapter
{
  ...
  public class StringsData
  {
    ...
    /**
     * @param the
     *          strings which is in this object.
     */
  ...
  public static void main(String args[]) throws FileNotFoundException
  {
    ...
    SequentialRecordSource supplier = listener.new LineSupplier(args[0]);
