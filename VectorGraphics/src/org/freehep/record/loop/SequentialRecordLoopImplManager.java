 ...
 *
 * Version $Id: SequentialRecordLoopImplManager.java,v 1.1 2009-03-04 22:46:56 andrew Exp $
 *
 ...
 * <code>SequentialRecordLoopManager</code> class that can manage the default
 * <code>SequentialRecordLoop</code> implementation.
 * 
 * @version $Id: SequentialRecordLoopImplManager.java,v 1.1 2006-07-03 13:33:34
 *          amcveigh Exp $
 * @author patton
 */
public class SequentialRecordLoopImplManager implements SequentialRecordLoopManager
{
   ...
   * 
   * @param recordLoop
   *          the object those loop is to be managed.
   */
