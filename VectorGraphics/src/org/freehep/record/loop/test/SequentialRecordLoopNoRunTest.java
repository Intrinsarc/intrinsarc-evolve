 ...
 *
 * Version $Id: SequentialRecordLoopNoRunTest.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 *
...
/**
 * This class defines the tests that any SequentialRecordLoop object should
 * pass.
 * 
 * @version $Id: SequentialRecordLoopNoRunTest.java,v 1.1 2006-07-03 13:33:15
 *          amcveigh Exp $
 * @author patton
 */
public abstract class SequentialRecordLoopNoRunTest extends TestCase
{
  ...
  protected static final Object[] TEST_OBJECTS = new Object[]{new Object(), new Object(), new Object(), new Object(),
      new Object()};

  protected static final boolean[] TEST_MIXED_RECORDS = new boolean[]{false, true, true, false, true,};
  ...
  private static final Object TEST_CONFIGURATION = new Object();

  private static final Object TEST_RECONFIGURATION = new Object();
  ...
  {
    byte[] stateSequence = {StateMachineTester.READY_STATE, StateMachineTester.CONFIGURED_STATE,
        StateMachineTester.SUSPENDED_STATE, StateMachineTester.READY_STATE};
   ...
   * implementation of the SequentialRecordLoop so must be provided by its test
   * class.
   */
  public abstract void testInterrupt();

  /**
   * Test that the interrupt flag gets cleared after an interrupt has been
   * serviced.
   */
  ...
  public void testMixedCount()
  {
    ...
    try
    {
      ...
      assertEquals(TEST_MIXED_EVENT_COUNT, testObject.getTotalCountableSupplied());
    }
    catch (LoopException e1)
    {
      fail("Threw LoopException Exception\n" + e1.toString());
  ...
  public void testPureCount()
  {
    ...
    try
    {
      ...
      assertEquals(TEST_OBJECTS.length, testObject.getTotalSupplied());
      assertEquals(TEST_OBJECTS.length, testObject.getTotalCountableSupplied());
    }
    catch (LoopException e1)
    {
      fail("Threw LoopException Exception\n" + e1.toString());
  ...
  {
    byte[] stateSequence = {StateMachineTester.READY_STATE, StateMachineTester.CONFIGURED_STATE,
        StateMachineTester.PROCESSING_STATE, StateMachineTester.SUSPENDED_STATE};
  ...
  {
    byte[] stateSequence = {StateMachineTester.READY_STATE, StateMachineTester.CONFIGURED_STATE,
        StateMachineTester.PROCESSING_STATE, StateMachineTester.SUSPENDED_STATE, StateMachineTester.CONFIGURED_STATE,
  ...
  protected class MockRecordSource implements SequentialRecordSource
  {
    ...
    /**
     * @param records
     *          an sequence of object to serve out.
     */
    ...
    public Object getCurrentRecord() throws EndOfSourceException
    {
  ...
  private class MockListener extends StateMachineTester
  {
    ...
    {
      Assert.assertEquals(TEST_CONFIGURATION, event.getConfiguration());
    ...
    public void recordSupplied(RecordSuppliedEvent event)
    {
      if (null != records)
      {
        Assert.assertSame(records[recordIndex], event.getRecord());
    ...
    {
      Assert.assertEquals(TEST_RECONFIGURATION, event.getConfiguration());
    ...
    /**
     * @param sets
     *          the sequence of expected records with their associated
     *          countablilty flags.
     */
    ...
    /**
     * @param sets
     *          the sequence of expected transitions.
     */
    ...
    protected void setState(byte state)
    {
      if (null != states)
      {
        ...
        stateIndex++;
        Assert.assertEquals(state, states[stateIndex]);
      }
