 ...
 *
 * Version $Id: SequentialRecordLoopImplTest.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 *
...
/**
 * This class defines the tests that any SequentialRecordLoopImpl object should
 * pass.
 * 
 * @version $Id: SequentialRecordLoopImplTest.java,v 1.1 2006-07-03 13:33:15
 *          amcveigh Exp $
 * @author patton
 */
public class SequentialRecordLoopImplTest extends SequentialRecordLoopNoRunTest
{
  ...
  private static final double[] PROGRESS_FRACTIONS = new double[]{0.0, 0.4, 0.8, 1.0};
  ...
  {
    testListenerAdd();
    testObject.addRecordLoopListener(new MockLoopListener(PROGRESS_FRACTIONS));
  ...
  private class MockInterruptor extends Thread
  {
    public void run()
    {
      synchronized (this)
  ...
  private class MockLoopListener extends RecordLoopAdapter
  {
    ...
    {
      assertEquals(fractions[fractionIndex], loopProgressEvent.getFraction(), DOUBLE_DELTA);
      fractionIndex++;
    }
  }

  private class MockPausingListener extends RecordAdapter
  {
