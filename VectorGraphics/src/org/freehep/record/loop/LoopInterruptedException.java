 ...
 *
 * Version $Id: LoopInterruptedException.java,v 1.1 2009-03-04 22:46:56 andrew Exp $
 *
 ...
 * This class is thrown by the "loop" method of the <code>{@link
 SequentialRecordLoop}</code>
 * interface if there is a request to interrupt the loop.
 * 
 * @version $Id: LoopInterruptedException.java,v 1.1 2006-07-03 13:33:34
 *          amcveigh Exp $
 * @author patton
 */
public class LoopInterruptedException extends LoopException
{
   ...
   *          exception.
   */
  public LoopInterruptedException(String s, long supplied, long countableSupplied)
  {
