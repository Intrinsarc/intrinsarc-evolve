 ...
 *
 * Version $Id: SequentialRecordLoopManager.java,v 1.1 2009-03-04 22:46:56 andrew Exp $
 *
 ...
 * </pre>
 * 
 * @version $Id: SequentialRecordLoopManager.java,v 1.1 2006-07-03 13:33:34
 *          amcveigh Exp $
 * @author patton
 */
public interface SequentialRecordLoopManager
{
   ...
   *           if this is called before a source is set in the
   *           SequentialRecordLoopImpl object being managed.
   */
   ...
   *           if target is non-negative and the source runs out of records.
   ...
   * @throws IOException
   *           if there is a problem reading the next record.
   */
   ...
   * the SequentialRecordLoopImpl object being managed.
   * 
   * @param record
