 ...
 * @version $Id: TagHandler.java,v 1.1 2009-03-04 22:46:56 andrew Exp $
 */
public class TagHandler
{
   ...
   * entity The characters < and > have to be written as &lt; and &gt; while the &
   * is written as &amp;
   * 
   * The following three methods are called: defaultEntity(entity) for &amp;
   * &lt; &gt; &quot; &apos; entity(entity) for all other entities openTag(tag)
   * for all <tags> endTag(tag) for all </tags> text(text) for all text
   * 
