 ...
 * @version $Id: VectorGraphicsConstants.java,v 1.1 2006-07-03 13:33:32 amcveigh
 *          Exp $
 */
public interface VectorGraphicsConstants
{
   ...
   * baseline of the text. This is the default in drawString calls which do not
   * specify an alignment.
   */
  public static final int TEXT_BASELINE = 0;

  /**
   * Constant indicating that a string should be aligned vertically with the top
   * of the text.
   */
  ...
  /**
   * Constant indicating that a string should be aligned by the center. This is
  ...
  /**
   * Constant indicating that the string should be aligned horizontally with the
