 ...
 * @version $Id: VectorGraphics.java,v 1.1 2009-03-04 22:46:56 andrew Exp $
 */
public abstract class VectorGraphics extends Graphics2D implements VectorGraphicsConstants
{
  ...
  public abstract boolean drawImage(Image image, int x, int y, int width, int height, Color bgColor,
      ImageObserver observer);
  public abstract boolean drawImage(Image image, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2,
   ...
   * 
   * @param x,
   *          y, width, height, startAngle, arcAngle specify the arc.
   */
   ...
   * 
   * @param x1,
   *          y1, x2, y2 endpoints of the line.
   */
   ...
   * 
   * @param x,
   *          y, width, height specify the bounding box of the oval.
   */
   ...
   * 
   * @param xPoints,
   *          yPoints, nPoints arrays to specify the points of the polyline.
   */
   ...
   * 
   * @param x,
   *          y, width, height coordinates of the rectangle
   */
   ...
   *          y, width, height coordinates of the rectangle.
   * @param arcWidth,
   *          arcHeight specify the roundness of the corners.
   */
   ...
   *          color of the banner
   */
  public abstract void drawString(String str, double x, double y, int horizontal, int vertical, boolean framed,
   ...
   *          color of the banner
   */
  public abstract void drawString(TagString str, double x, double y, int horizontal, int vertical, boolean framed,
      Color frameColor, double frameWidth, boolean banner, Color bannerColor);
