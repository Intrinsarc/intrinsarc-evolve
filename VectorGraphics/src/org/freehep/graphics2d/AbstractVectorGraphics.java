 ...
 * @version $Id: AbstractVectorGraphics.java,v 1.1 2006-07-03 13:33:32 amcveigh
 *          Exp $
 */
public abstract class AbstractVectorGraphics extends VectorGraphics
{
  ...
  {
    drawArc((double) x, (double) y, (double) width, (double) height, (double) startAngle, (double) arcAngle);
  }
  ...
  {
    drawRoundRect(x, y, (double) width, (double) height, (double) arcWidth, (double) arcHeight);
  }
  ...
  public void setLineWidth(double width)
  {
    ...
    if (stroke instanceof BasicStroke)
    {
      ...
      {
        stroke = new BasicStroke((float) width, cs.getEndCap(), cs.getLineJoin(), cs.getMiterLimit(),
            cs.getDashArray(), cs.getDashPhase());
        setStroke(stroke);
      }
    }
    else
   ...
   * 
   * @param xPoints,
   *          yPoints, nPoints coordinates of the polyline.
   * @param close
   *          is shape closed
   */
