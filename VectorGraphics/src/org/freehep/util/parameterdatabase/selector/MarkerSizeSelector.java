...
public class MarkerSizeSelector extends Selector
{
  ...
  public static MarkerSizeSelector SMALL = new MarkerSizeSelector("Small", new Double(3.));
  public static MarkerSizeSelector MEDIUM = new MarkerSizeSelector("Medium", new Double(5.));
  public static MarkerSizeSelector LARGE = new MarkerSizeSelector("Large", new Double(7.));
