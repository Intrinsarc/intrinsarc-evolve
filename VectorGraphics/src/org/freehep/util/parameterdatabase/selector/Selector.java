...
abstract public class Selector
{
  ...
  /**
   * This constructor will create a Selector from the given tag. Subclasses must
  ...
  /**
   * This returns an iterator over all of the possible Selector objects of this
   * class.
   */
  ...
  /**
   * This returns the value associated with this Selector as a double. This will
   * throw a ClassCastException if the underlying value is not an Double.
   */
