...
public class LineSizeSelector extends Selector
{
  ...
  protected static BasicStroke thinStroke = new BasicStroke(1.f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);

  protected static BasicStroke normalStroke = new BasicStroke(2.f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);

  protected static BasicStroke thickStroke = new BasicStroke(3.f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
