...
public class ParameterDatabaseXMLReader extends DefaultHandler
{
  ...
  public void readParameters(ParameterDatabase database, Reader reader, Hashtable instanceMap) throws SAXException,
      IOException
  {
  ...
  public void startElement(String namespace, String tag, String qName, Attributes atts) throws SAXException
  {
    ...
    if (tag.equals("ClassParameter"))
    {
      ...
      if (className != null && parameterName != null && valueAsString != null && valueTypeAsString != null)
      {
        ...
        try
        {
          ...
          database.addParameter(parameterName, newValue, cIterator, null, true);
      ...
      if (tag.equals("InstanceParameter"))
      {
        ...
        if (id != null && parameterName != null && valueAsString != null && valueTypeAsString != null)
        {
          ...
          try
          {
            ...
            if (instance instanceof PropertyChangeListener)
            {
              ...
              database.addParameter(parameterName, newValue, cIterator, pcl, true);
            }
            else
            {
              database.addParameter(parameterName, newValue, cIterator, null, true);
