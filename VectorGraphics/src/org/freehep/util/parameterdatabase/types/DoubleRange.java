...
public class DoubleRange
{
   ...
   * from the given minimum to the given maximum. The endpoints are included in
   * this range.
   */
   ...
   * [min,max], where min and max are valid double strings. If min or max is an
   * empty string, then it represents the smallest or largest double,
  ...
  /**
   * This exception will be thrown if the String describing the range is invalid
   * for any reason.
   */
