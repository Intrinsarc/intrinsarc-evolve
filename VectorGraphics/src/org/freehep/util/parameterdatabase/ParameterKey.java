...
public class ParameterKey
{
  ...
  /**
   * This monitors the state of this ParameterKey. If this key has been cleared,
   * then this ParameterKey is invalid and most user-visible calls will return
   ...
   * parameters. Users should not create ParameterKeys via this constructor, but
   * should instead use the static factory method createParameterKey().
   */
   ...
   * operations should be performed on the returned object which will affect the
   * results of the equals() method.
   */
   ...
   * object will be available for reuse only after the JVM determines that there
   * are no more outstanding references to this ParameterKey and the JVM runs
   * the finalize() method.
   */
   ...
   * It is added to the list of recycled keys if the inventory is below the
   * given limit.
   */
