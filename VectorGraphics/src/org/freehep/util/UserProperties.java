 ...
 * @version $Id: UserProperties.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
...
public class UserProperties extends Properties
{
  ...
  /**
   * Constructs UserProperties with a defaults and altDefaults table, which are
  ...
  public static Object setProperty(Properties properties, String key, Color value)
  {
    if (value == null)
      return properties.setProperty(key, "null");
    return properties.setProperty(key, value.getRed() + ", " + value.getGreen() + ", " + value.getBlue() + ", "
        + value.getAlpha());
  }
  ...
  public Color getPropertyColor(String key, Color def)
  {
    ...
    String[] r = s.split(", ");
    return new Color(Integer.parseInt(r[0]), Integer.parseInt(r[1]), Integer.parseInt(r[2]), Integer.parseInt(r[3]));
  }
  ...
  public Insets getPropertyInsets(String key, Insets def)
  {
    ...
    String[] r = s.split(", ");
    return new Insets(Integer.parseInt(r[0]), Integer.parseInt(r[1]), Integer.parseInt(r[2]), Integer.parseInt(r[3]));
  }
