 ...
 * @version $Id: CommandLineTest.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
public class CommandLineTest
{
  ...
  {
    String[][] test = {{"-version"}, {"--version"}, {"-verbose", "parameter1", "parameter2", "parameter3"},
        ...
        {"-unknownoption", "somevalue", "parameter1", "parameter2", "parameter3"}, {"-help"}, {"-h"},
        {"-verbose", "too", "few parameters"}, {"-cp"}, {"-Iincludedir1", "par1", "par2", "par3"},
