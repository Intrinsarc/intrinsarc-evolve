...
public class CommandLineUnitTest extends TestCase
{
  ...
  {
    assertTrue(cl.parse(new String[]{"-cp", "classpath", "parameter1", "parameter2", "parameter3", "optional1",
        "optional2"}));
  ...
  /*
   * public void testTooManyArguments() throws CommandLineException { try {
   * assertTrue(cl.parse(new String[] {"-verbose","too","few parameters"})); }
   * catch (TooManyArgumentsException tmae) { return; } fail("Expected
