 ...
 * </PRE>
 * 
 * Template book2 = new Template(); book2.set("author", "Garmash Viacheslav");
 * book2.set("title", "Creating web shop using JavaBY Template Engine.");
 * book2.set("year", "2002"); store.append("book", book2);
 * 
 * TemplateEngine engine = new TemplateEngine(); engine.addValueProvider(store);
 * Reader in = new
 * InputStreamReader(Test.class.getResourceAsStream("test.html")); Reader out =
 * engine.filter(in);
 * 
 * </pre>
 * 
 * @author tonyj
 * @version $Id: Template.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
