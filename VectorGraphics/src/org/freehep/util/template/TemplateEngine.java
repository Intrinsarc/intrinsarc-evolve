 ...
 * it by looking for tags in the document, and replacing them with values
 * provided by a set of ValueProviders.
 * <p>
 ...
 * @author tonyj
 * @version $Id: TemplateEngine.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
        ...
        if (templateMarker > 0)
        {
          ...
          if (state == 0 && c == '<')
            ...
            if (state == 1 && c == '/')
              ...
              if (state > 1 && buf.charAt(state - 1) == c)
                state++;
              else
                state = 0;
