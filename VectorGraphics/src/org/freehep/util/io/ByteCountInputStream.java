 ...
 * @version $Id: ByteCountInputStream.java,v 1.1 2006-07-03 13:32:51 amcveigh
 *          Exp $
 */
public class ByteCountInputStream extends ByteOrderInputStream
{
  ...
  public void pushBuffer(int len)
  {
    ...
    if (index >= 0)
    {
      if (size[index] < len)
      {
        System.err.println("ByteCountInputStream: trying to set a length: " + len
            + ", longer than the underlying buffer: " + size[index]);
        return;
      }
      size[index] -= len;
    }
