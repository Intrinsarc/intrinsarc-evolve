 ...
 * Each segment needs to start with "<?xml". Methods hasNext() and next()
 * should be called to retrieve the inputstream for the XMLParser.
 * 
 * Typical usage:
 * 
 * <PRE>
 ...
 * @version $Id: XMLSequence.java,v 1.1 2009-03-04 22:46:49 andrew Exp $
 */
public class XMLSequence extends InputStream
{

  // divider string
  private static final int[] xml = new int[]{'<', '?', 'x', 'm', 'l', ' '};
