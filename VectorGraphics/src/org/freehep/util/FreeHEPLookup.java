...
/**
 * A simple lookup which allows adding and removing items. This is just a simple
 * front-end to the netbeans lookup api. It provides the ability to lookup
 * classes registered via the Sun service provider mechanism or registered
 * directly with this class.
 * 
 * @see <a href="http://openide.netbeans.org/lookup/">The Netbeans Lookup API</a>
 * @see <a
 *      href="http://java.sun.com/j2se/1.3/docs/guide/jar/jar.html#Service%20Provider">The
 *      service provider mechanism</a>
 * @author tonyj
 * @version $Id: FreeHEPLookup.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
public class FreeHEPLookup extends Lookup
{
   ...
   *          The instance to add.
   * @param ids
   *          The IDs associated with the instance.
   */
