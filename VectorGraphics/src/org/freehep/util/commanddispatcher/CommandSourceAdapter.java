...
/**
 * A class which implements CommandSource and can be used to associate any
 * AbstractButton with a command
 * 
...
public class CommandSourceAdapter implements CommandSource, ActionListener, BooleanCommandState, Observer
{
  ...
  public CommandSourceAdapter(AbstractButton button)
  {
    ...
    m_bool = m_button instanceof JCheckBoxMenuItem || m_button instanceof JRadioButtonMenuItem
        || m_button instanceof JToggleButton;
  }
