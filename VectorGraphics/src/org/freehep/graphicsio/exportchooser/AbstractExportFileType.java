 ...
 * @version $Id: AbstractExportFileType.java,v 1.1 2006-07-03 13:32:56 amcveigh
 *          Exp $
 */
public abstract class AbstractExportFileType extends ExportFileType
{
  ...
  private class MultiPageSingleFileExportThread extends CancelThread
  {
    ...
    private MultiPageSingleFileExportThread(MultiPageDocument mdoc, VectorGraphics g, Component[] saveTargets,
        ProgressDialog progress)
    {
  ...
  private class MultipageMultipleFilesExportThread extends CancelThread
  {
    ...
    private MultipageMultipleFilesExportThread(Component[] saveTargets, File file, ProgressDialog progress,
   ...
   */
  public VectorGraphics getGraphics(File file, Component target) throws java.io.IOException
  {
    return getGraphics(new BufferedOutputStream(new FileOutputStream(file)), target);
  }

  /**
   * The method returns a graphics context specific for this ExportFileType.
   */
  public abstract VectorGraphics getGraphics(OutputStream os, Component printTarget) throws java.io.IOException;

  /**
   * Show this dialog and save component as the given file type.
   */
  public void exportToFile(OutputStream os, Component target, Component parent, Properties properties, String creator)
   ...
   * Show this dialog and save component as the given file type.
   */
  public void exportToFile(File file, Component target, Component parent, Properties properties, String creator)
      throws java.io.IOException
  {
   ...
   * <tt>getConfiguredGraphics(OutputStream, Component[])</tt> does not return
   * a <tt>MultiPageDocument</tt> (or null) <tt>saveTargets.length</tt>
   * numbered documents are created each of which contains a single page.
   */
  public void exportToFile(OutputStream os, Component[] targets, Component parent, Properties properties, String creator)
      throws java.io.IOException
  {
   ...
   * numbered documents are created each of which contains a single page.
   */
  public void exportToFile(File file, Component[] targets, Component parent, Properties properties, String creator)
      throws java.io.IOException
  {
