 ...
 * @version $Id: PageMarginPanel.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
public class PageMarginPanel extends OptionPanel
{

  final private static String pageMarginList[] = {"Custom", PageConstants.SMALL, PageConstants.MEDIUM,
      PageConstants.LARGE};
  ...
  public boolean applyChangedOptions(Properties options)
  {
    ...
    Insets margins = new Insets(((Number) top.getValue()).intValue(), ((Number) left.getValue()).intValue(),
        ((Number) bottom.getValue()).intValue(), ((Number) right.getValue()).intValue());
