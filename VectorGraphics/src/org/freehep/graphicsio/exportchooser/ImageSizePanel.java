 ...
 * @version $Id: ImageSizePanel.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
public class ImageSizePanel extends OptionPanel
{

  final private static String imageSizeList[] = {"ImageSize", "Custom", ScreenConstants.VGA, ScreenConstants.SVGA,
      ScreenConstants.XGA, ScreenConstants.SXGA, ScreenConstants.SXGA_PLUS, ScreenConstants.UXGA};
  ...
  public boolean applyChangedOptions(Properties options)
  {
    ...
    Dimension size = new Dimension(((Number) imageWidth.getValue()).intValue(), ((Number) imageHeight.getValue())
        .intValue());
