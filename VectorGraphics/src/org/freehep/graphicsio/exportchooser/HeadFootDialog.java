 ...
 * @version $Id: HeadFootDialog.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
public class HeadFootDialog extends JDialog implements ActionListener, ItemListener
{
  ...
  public void configure(MultiPageDocument md)
  {
    if (text[0] != null)
    {
      md.setHeader(new Font("times", Font.PLAIN, 10), text[0][0], text[0][1], text[0][2], 1);
    }

    if (text[1] != null)
    {
      md.setFooter(new Font("times", Font.PLAIN, 10), text[1][0], text[1][1], text[1][2], 1);
    }
