 ...
 * @version $Id: TestColorMap.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 */
  ...
  class TestPanel extends JPanel
  {
    ...
    public void paintComponent(Graphics g)
    {
      if (g != null)
      {
        ...
        g.setColor(bkgColor);
        g.fillRect(insets.left, insets.top, dim.width - insets.left - insets.right, dim.height - insets.top
            - insets.bottom);
      }
    }
  }
