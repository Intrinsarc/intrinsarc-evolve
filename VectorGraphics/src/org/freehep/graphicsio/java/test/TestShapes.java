...
public class TestShapes extends TestingPanel
{
  ...
  private static class Paint0s0
  {
    public static void paint(VectorGraphics[] vg)
    {
      ...
      vg[1].drawPolygon(new int[]{505, 595, 505, 595}, new int[]{7, 68, 68, 7}, 4);
      vg[1].setColor(new Color(255, 0, 0, 255));
      vg[1].drawPolyline(new int[]{5, 95, 5, 95}, new int[]{82, 143, 143, 82}, 4);
      vg[1].setColor(new Color(0, 255, 0, 255));
      ...
      vg[1].setColor(new Color(0, 0, 0, 255));
      vg[1].setColor(new Color(255, 255, 0, 255));
      vg[1].fillPolygon(new int[]{505, 595, 505, 595}, new int[]{82, 143, 143, 82}, 4);
      vg[1].setColor(new Color(0, 0, 0, 255));
      vg[1].drawPolygon(new int[]{505, 595, 505, 595}, new int[]{82, 143, 143, 82}, 4);
      ...
      vg[1].setColor(new Color(255, 255, 0, 255));
      vg[1].drawPolygon(new int[]{505, 595, 505, 595}, new int[]{157, 218, 218, 157}, 4);
      vg[1].setColor(new Color(255, 0, 0, 255));
      vg[1].drawPolyline(new int[]{5, 95, 5, 95}, new int[]{232, 293, 293, 232}, 4);
      vg[1].setColor(new Color(0, 255, 0, 255));
      ...
      vg[1].setColor(new Color(0, 0, 0, 255));
      vg[1].setColor(new Color(255, 255, 0, 255));
      vg[1].fillPolygon(new int[]{505, 595, 505, 595}, new int[]{232, 293, 293, 232}, 4);
      vg[1].setColor(new Color(0, 0, 0, 255));
      vg[1].drawPolygon(new int[]{505, 595, 505, 595}, new int[]{232, 293, 293, 232}, 4);
