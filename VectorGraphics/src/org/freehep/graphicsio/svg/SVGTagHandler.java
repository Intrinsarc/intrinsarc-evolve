 ...
 * @version $Id: SVGTagHandler.java,v 1.1 2009-03-04 22:46:58 andrew Exp $
 */
public class SVGTagHandler extends TagHandler
{
  ...
  public static void main(String[] args)
  {
    ...
    SVGTagHandler handler = new SVGTagHandler(true, new Font("Helvetica", 18, Font.PLAIN), new FontRenderContext(
