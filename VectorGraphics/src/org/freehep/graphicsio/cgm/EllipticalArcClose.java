 ...
 * @version $Id: EllipticalArcClose.java,v 1.1 2009-03-04 22:46:48 andrew Exp $
 */
public class EllipticalArcClose extends EllipticalArc
{
  ...
  public EllipticalArcClose(Point2D p, Point2D c1, Point2D c2, Point2D delta0, Point2D delta1, int closure)
  {
    this();
    this.p = p;
    this.c1 = c1;
