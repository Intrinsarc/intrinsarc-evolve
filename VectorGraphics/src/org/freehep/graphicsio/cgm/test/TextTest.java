...
public class TextTest
{
  ...
  public static void main(String[] args) throws IOException
  {
    ...
    cgm.add(new FontList(new String[]{"Courier", "Courier-Bold", "Courier-Italic", "Courier-BoldItalic", "Helvetica",
        "Helvetica-Bold", "Helvetica-Italic", "Helvetica-BoldItalic", "TimesRoman", "TimesRoman-Bold",
    ...
    cgm.add(new VDCExtent(new Point2D.Double(0, 6000), new Point2D.Double(6000, 0)));
    ...
    cgm.add(new Text(new Point2D.Double(100, 2400), "Helvetica-BoldItalic"));
    ...
    cgm.add(new Text(new Point2D.Double(100, 3600), "TimesRoman-BoldItalic"));
    ...
    CGMOutputStream out = new CGMOutputStream(new FileOutputStream("TextTest.cgm"));
