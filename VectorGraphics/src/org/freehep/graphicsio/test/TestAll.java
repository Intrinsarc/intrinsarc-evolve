 ...
 * @version $Id: TestAll.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
public class TestAll extends TestingPanel implements VectorGraphicsConstants
{
  ...
  public void paintComponent(Graphics g)
  {
    ...
    if (marble == null)
    {
      ...
      sky = new BufferedImage(skyI.getWidth(this), skyI.getHeight(this), BufferedImage.TYPE_INT_RGB);
    ...
    vg.setPaint(new GradientPaint((int) 0, (int) 10, Color.blue, (int) width, (int) 10, Color.white));
    vg.fillRect(0, 10, width, 30);
    vg.setFont(new Font("Helvetica", Font.BOLD, 18));
    vg.setPaint(new GradientPaint((int) 0, (int) 10, Color.black, (int) width, (int) 10, Color.blue));
    ...
    vg.drawString(new TagString("The <i>drawString</i> methods in <i>VectorGraphics</i> support"), fx + 3 * width / 16,
        fy - width / 8 + 10);
    vg.drawString(new TagString("output of strings using a subset of the <b>HTML language</b>."), fx + 3 * width / 16,
        fy - width / 8 + 24);
    ...
    vg.setPaint(new TexturePaint(sky, new Rectangle2D.Double(0, 0, sky.getWidth(), sky.getHeight())));
    double mx = 0;
    double my = height / 2;
    vg.fillRect(mx, my, width / 2, height / 2);
    vg.setPaint(Color.black);
    vg.setFont(new Font("Impact", Font.BOLD, 60));
    vg.drawString("\u2729Impact\u2729", mx + width / 4, my + height / 4, vg.TEXT_CENTER, vg.TEXT_BASELINE);
    ...
    svg.setStroke(new BasicStroke(8.f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 10.f, null, 0.f));
    svg.draw(shape);

    subgraphics = svg.create();
    VectorGraphics svg2 = VectorGraphics.create(subgraphics);
    svg2.setColor(Color.black);
    svg2.setStroke(new BasicStroke(3.f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10.f, dash, 0.f));
    ...
    svg.setStroke(new BasicStroke(4.f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10.f, null, 0.f));
