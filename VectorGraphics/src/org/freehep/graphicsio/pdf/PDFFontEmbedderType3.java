 ...
 * @version $Id: PDFFontEmbedderType3.java,v 1.1 2006-07-03 13:32:34 amcveigh
 *          Exp $
 */
public class PDFFontEmbedderType3 extends PDFFontEmbedder
{
  ...
  protected void writeGlyph(String characterName, Shape glyph, GlyphMetrics glyphMetrics) throws IOException
  {
    ...
    PDFStream glyphStream = pdf.openStream(createCharacterReference(characterName), new String[]{"Flate", "ASCII85"});
    ...
    glyphStream.glyph(advance, 0, bounds.getX(), bounds.getY(), bounds.getX() + bounds.getWidth(), bounds.getY()
        + bounds.getHeight());
