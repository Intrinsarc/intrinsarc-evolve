...
/**
 * This class tests the user-level PDF Writer interfaces. It simply writes a
 * document with several pages, including some text and graphics.
 * <p>
 * 
 * @author Mark Donszelmann
 * @version $Id: PDFWriterTest.java,v 1.1 2009-03-04 22:46:58 andrew Exp $
 */
public class PDFWriterTest
{
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    PDFOutline firstOutline = pdf.openOutline("FirstOutline", "Text Page", "Outlines", null, "SecondOutline");
    firstOutline.setDest(new Object[]{pdf.ref("FirstPage"), pdf.name("Fit")});
    pdf.close(firstOutline);

    PDFOutline secondOutline = pdf.openOutline("SecondOutline", "Graphics Page", "Outlines", "FirstOutline",
        "LastOutline");
    secondOutline.setDest(new Object[]{pdf.ref("SecondPage"), pdf.name("Fit")});
    pdf.close(secondOutline);

    PDFOutline lastOutline = pdf.openOutline("LastOutline", "Image Page", "Outlines", "SecondOutline", null);
    ...
    secondThumb.image(ImageUtilities.createRenderedImage(image2, null, Color.BLACK), Color.BLACK, new String[]{"Flate",
        "ASCII85"});
    ...
    third.inlineImage(ImageUtilities.createRenderedImage(image1, null, Color.BLACK), Color.BLACK, new String[]{"Flate",
        "ASCII85"});
    third.restore();
    pdf.close(third);

    // our page proc set
    pdf.object("OurPageProcSet", new Object[]{pdf.name("PDF"), pdf.name("Text"), pdf.name("ImageC")});
