 ...
 * @version $Id: PDFFontEmbedder.java,v 1.1 2009-03-04 22:46:57 andrew Exp $
 */
public abstract class PDFFontEmbedder extends FontEmbedder
{
  ...
  /**
   * Returns the reference String that identifies the font dictionary. Use this
   * reference plus underscore plus suffix for other dictionaries.
   */
