...
public class PDFFontIncluder extends FontIncluder
{
  ...
  public PDFFontIncluder(FontRenderContext context, PDFWriter pdf, String reference,
  ...
  protected void openIncludeFont() throws IOException
  {
    ...
    font.entry("Encoding", redundanceTracker.getReference(getEncodingTable(), PDFCharTableWriter.getInstance()));
    pdf.close(font);
  }
  ...
  public static boolean isStandardFont(Font font)
  {
    ...
    return (fontName.indexOf("helvetica") >= 0) || (fontName.indexOf("times") >= 0)
        || (fontName.indexOf("courier") >= 0) || (fontName.indexOf("symbol") >= 0)
