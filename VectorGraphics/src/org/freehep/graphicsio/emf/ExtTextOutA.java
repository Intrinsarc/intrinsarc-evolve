 ...
 * @version $Id: ExtTextOutA.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class ExtTextOutA extends EMFTag implements EMFConstants
{
  ...
  public EMFTag read(int tagID, EMFInputStream emf, int len) throws IOException
  {
    ...
    ExtTextOutA tag = new ExtTextOutA(emf.readRECTL(), emf.readDWORD(), emf.readFLOAT(), emf.readFLOAT(), new Text(emf));
    return tag;
  }
