 ...
 * @version $Id: LogFontW.java,v 1.1 2009-03-04 22:46:50 andrew Exp $
 */
public class LogFontW implements EMFConstants
{
  ...
  public LogFontW(int height, int width, int escapement, int orientation, int weight, boolean italic,
