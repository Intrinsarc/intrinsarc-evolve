 ...
 * @version $Id: EMFPathConstructor.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class EMFPathConstructor extends QuadToCubicPathConstructor implements EMFConstants
{
  ...
  private void addPoint(int n, double x, double y)
  {
    ...
    if (wide || (ix < Short.MIN_VALUE) || (ix > Short.MAX_VALUE) || (iy < Short.MIN_VALUE) || (iy > Short.MAX_VALUE))
    {
      wide = true;
    }
