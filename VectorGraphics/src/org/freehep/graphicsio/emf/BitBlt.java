 ...
 * @version $Id: BitBlt.java,v 1.1 2009-03-04 22:46:50 andrew Exp $
 */
public class BitBlt extends EMFTag implements EMFConstants
{
  ...
  public BitBlt(Rectangle bounds, int x, int y, int width, int height, AffineTransform transform, RenderedImage image,
      Color bkg)
  {
    this();
    this.bounds = bounds;
  ...
  public void write(int tagID, EMFOutputStream emf) throws IOException
  {
    ...
    BitmapInfoHeader header = new BitmapInfoHeader(image.getWidth(), image.getHeight(), 24, BI_RGB, length, 0, 0, 0, 0);
