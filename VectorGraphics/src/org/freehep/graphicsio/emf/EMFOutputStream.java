 ...
 * @version $Id: EMFOutputStream.java,v 1.1 2009-03-04 22:46:50 andrew Exp $
 */
public class EMFOutputStream extends TaggedOutputStream
{
  ...
  public EMFOutputStream(OutputStream os, Rectangle imageBounds, EMFHandleManager handles, String application,
  ...
  public EMFOutputStream(OutputStream os, Rectangle imageBounds, EMFHandleManager handles, String application,
      String name, Dimension device) throws IOException
  {
  ...
  public void close() throws IOException
  {
    int len = popBuffer();
    recordCount++;
    EMFHeader header = new EMFHeader(imageBounds, getVersion(), 0, len, recordCount, handles.maxHandlesUsed(),
