 ...
 * @version $Id: AlphaBlend.java,v 1.1 2009-03-04 22:46:50 andrew Exp $
 */
public class AlphaBlend extends EMFTag implements EMFConstants
{
  ...
  public void write(int tagID, EMFOutputStream emf) throws IOException
  {
    ...
    BitmapInfoHeader header = new BitmapInfoHeader(image.getWidth(), image.getHeight(), 32, encode, length, 0, 0, 0, 0);
