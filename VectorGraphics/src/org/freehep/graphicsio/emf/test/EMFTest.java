...
public class EMFTest extends JPanel
{
  ...
  public void run() throws IOException
  {
    ...
    Point p1[][] = {{new Point(40, 50), new Point(160, 170), new Point(80, 30)}};
    Point p2[] = {new Point(20, 20), new Point(40, 60), new Point(30, 50), new Point(00, 60)};
    ...
    emf.add(new SetViewportExtEx(new Dimension(bounds.width, bounds.height)));
     ...
     * CreateBrushIndirect(1, brush)); emf.add(new SelectObject(1)); ExtLogPen
     * pen1 = new ExtLogPen(ExtLogPen.PS_GEOMETRIC | ExtLogPen.PS_SOLID |
     * ExtLogPen.PS_ENDCAP_ROUND | ExtLogPen.PS_JOIN_ROUND, 5,
     * ExtLogPen.BS_SOLID, Color.green, 0, new int[0]); emf.add(new
     * ExtCreatePen(2, pen1)); emf.add(new SelectObject(2)); emf.add(new
     * SetMiterLimit(10)); emf.add(new PolyPolygon(bounds, p1)); emf.add(new
     * DeleteObject(1)); emf.add(new DeleteObject(2));
     * 
     * emf.add(new GDIComment("Polyline")); emf.add(new ModifyWorldTransform(new
     * AffineTransform(1, 0, 0, 1, 200, 0),
     ...
     * DeleteObject(1));
     * 
     * emf.add(new GDIComment("Ellipse")); emf.add(new ModifyWorldTransform(new
     * AffineTransform(1, 0, 0, 1, 200, 0),
     ...
     * 
     * emf.add(new GDIComment("Image")); emf.add(new ModifyWorldTransform(new
     * AffineTransform(1, 0, 0, 1, 0, 200),
    ...
    emf.add(new StretchDIBits(bounds, 0, 0, image.getWidth(this), image.getHeight(this), ImageUtilities
        .createRenderedImage(image, this, Color.BLACK), Color.BLACK));
    /*
     ...
     * ExtLogFontW extFont = new ExtLogFontW(font, "", "", 0, 0, 0, new byte[]
     * {0, 0, 0, 0}, 0, panose); emf.add(new ExtCreateFontIndirectW(1,
     * extFont));
     * 
    ...
    EMFOutputStream out = new EMFOutputStream(new FileOutputStream("EMFTest.emf"), bounds, new EMFHandleManager(),
        "EMFTest", "TestFile", new Dimension(1024, 768));
