 ...
 * @version $Id: StretchDIBits.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class StretchDIBits extends EMFTag implements EMFConstants
{
  ...
  public StretchDIBits(Rectangle bounds, int x, int y, int width, int height, RenderedImage image, Color bkg)
  {
    this();
    this.bounds = bounds;
    this.x = x;
