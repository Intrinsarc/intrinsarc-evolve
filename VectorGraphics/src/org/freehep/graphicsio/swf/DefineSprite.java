 ...
 * @version $Id: DefineSprite.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class DefineSprite extends DefinitionTag
{
  ...
  public SWFTag read(int tagID, SWFInputStream swf, int len) throws IOException
  {
    ...
    SWFInputStream sprite = new SWFInputStream(swf, new SWFSpriteTagSet(version), new SWFActionSet(version));
