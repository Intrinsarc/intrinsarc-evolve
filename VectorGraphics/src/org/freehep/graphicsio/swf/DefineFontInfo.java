 ...
 * @version $Id: DefineFontInfo.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class DefineFontInfo extends DefinitionTag
{
  ...
  public DefineFontInfo(int fontID, String name, boolean shiftJIS, boolean ansi, boolean italic, boolean bold,
      boolean wideCodes, int[] codes)
  {
    this();
    this.fontID = fontID;
    this.name = name;
