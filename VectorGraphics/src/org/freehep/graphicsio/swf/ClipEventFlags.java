 ...
 * @version $Id: ClipEventFlags.java,v 1.1 2009-03-04 22:46:52 andrew Exp $
 */
public class ClipEventFlags
{
  ...
  {
    // All bits were 0?
    return !(keyPress || dragOut || dragOver || rollOut || rollOver || releaseOutside || release || press || initialize
        || data || keyUp || keyDown || mouseUp || mouseDown || mouseMove || unload || enterFrame || load);
  }
