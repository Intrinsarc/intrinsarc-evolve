 ...
 * @version $Id: DefineButton2.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class DefineButton2 extends DefinitionTag
{
  ...
  public DefineButton2(int id, boolean trackAsMenu, Vector buttons, Vector conditions)
  {
    this();
    character = id;
  ...
  public void write(int tagID, SWFOutputStream swf) throws IOException
  {
    ...
    for (int i = 0; i < conditions.size(); i++)
    {
      ...
      swf.writeUnsignedShort((i == conditions.size() - 1) ? 0 : actionOffset);
      swf.append();
    }
  }
