 ...
 * @author Steve Hannah
 * @version $Id: DefineFont2.java,v 1.1 2009-03-04 22:46:51 andrew Exp $
 */
public class DefineFont2 extends DefinitionTag implements SWFConstants
{
  ...
  {
    this(character, false, false, italic, bold, true, true, LANGUAGE_LATIN, name, shapes, codes, 0, 0, 0, null, null,
        null);
  }

  public DefineFont2(int character, boolean shiftJIS, boolean ansi, boolean italic, boolean bold, boolean wideOffsets,
      boolean wideCodes, int languageCode, String name, SWFShape[] shapes, int[] codes, int ascent, int descent,
      int leading, short[] advances, Rectangle2D[] bounds, KerningRecord[] kerning)
  {
    this();
  ...
  public SWFTag read(int tagID, SWFInputStream swf, int len) throws IOException
  {
    ...
    tag.codes = (tag.wideCodes) ? swf.readUnsignedShort(glyphCount) : swf.readUnsignedByte(glyphCount);
  ...
  {
    boolean hasLayout = (ascent != 0) || (descent != 0) || (leading != 0) || (advances != null) || (bounds != null)
        || (kerning != null);
  ...
  public static class KerningRecord
  {
    ...
    public KerningRecord(SWFInputStream input, boolean wideCodes) throws IOException
    {
      ...
      code1 = (wideCodes) ? input.readUnsignedShort() : input.readUnsignedByte();
      code2 = (wideCodes) ? input.readUnsignedShort() : input.readUnsignedByte();
