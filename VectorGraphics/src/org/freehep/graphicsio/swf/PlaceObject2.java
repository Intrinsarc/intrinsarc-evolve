 ...
 * @version $Id: PlaceObject2.java,v 1.1 2009-03-04 22:46:52 andrew Exp $
 */
public class PlaceObject2 extends ControlTag
{
  ...
  public PlaceObject2(boolean move, int depth, int id, AffineTransform matrix, ColorXform cxform, int ratio,
      String name, int clipDepth)
  {
    this();
    this.move = move;
    this.depth = depth;
  ...
  public void write(int tagID, SWFOutputStream swf) throws IOException
  {
    ...
    if (allEventFlags != null)
    {
      ...
      {
        ClipActionRecord clipActionRecord = (ClipActionRecord) clipActionRecords.get(i);
