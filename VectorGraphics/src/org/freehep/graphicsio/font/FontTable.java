 ...
 * @version $Id: FontTable.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
public abstract class FontTable
{
  ...
  /**
   * Called whenever a specific font is used for the first time. Subclasses may
   * use this method to include the font instantly. This method may change the
   * value of the reference by calling <tt>e.setReference(String)</tt> e.g. if
   * it wants to substitute the font by a standard font that can be addressed
   * under a name different from the generated one.
   */
   ...
   * is generated if the font was not used yet. For different fontsizes the same
   * name is returned.
   */
  public String fontReference(Font font, boolean embed, String embedAs)
  {
    font = substituteFont(font);
    String key = font.getName() + (font.isBold() ? "[bold]" : "") + (font.isItalic() ? "[italic]" : "");
  ...
  /**
   * Returns a Collection view of all fonts. The elements of the collection are
   * <tt>Entrie</tt>s.
   */
