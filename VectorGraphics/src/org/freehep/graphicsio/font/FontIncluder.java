 ...
 * @version $Id: FontIncluder.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
public abstract class FontIncluder
{
  ...
  /**
   * Writes the given information about the font into the file. When this method
   * is called all <tt>getXXX()</tt> are guaranteed to return reasonable
   * values.
   */
