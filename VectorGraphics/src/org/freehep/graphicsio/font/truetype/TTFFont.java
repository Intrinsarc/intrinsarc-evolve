 ...
 * @version $Id: TTFFont.java,v 1.1 2009-03-04 22:46:54 andrew Exp $
 */
public abstract class TTFFont
{
   ...
   * are read on demand (<tt>getTable()</tt>. It might be useful to call it
   * in order to print out all available information.
   */
