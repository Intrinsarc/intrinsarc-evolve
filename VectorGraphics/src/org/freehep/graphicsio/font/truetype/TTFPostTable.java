 ...
 * @version $Id: TTFPostTable.java,v 1.1 2009-03-04 22:46:54 andrew Exp $
 */
public class TTFPostTable extends TTFTable
{
  ...
  {
    String str = super.toString() + " format: " + format + "\n  italic:" + italicAngle + " ulPos:" + underlinePosition
        + " ulThick:" + underlineThickness + " isFixed:" + isFixedPitch;
