 ...
 * @version $Id: FontEmbedder.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
public abstract class FontEmbedder extends FontIncluder
{
   ...
   * <tt>unicodeName</tt> equals the value of <tt>NOTDEF</TT> (=<tt>.notdef</tt>).
   * 
   * @param unicodeName
  ...
  {
    // This one-line implementation produces different results under JDK 1.3 and
    // 1.4
  ...
  private Shape createUndefined()
  {
    ...
    ud.append(new Rectangle2D.Double(FONT_SIZE / 20, FONT_SIZE / 20, 18 * FONT_SIZE / 20, 18 * FONT_SIZE / 20), false);
    return ud;
  }
}
