 ...
 * 
 * Uses an algorithm puplished as ActionScript (SWF) by:
 * 
 ...
 * @version $Id: CubicToQuadPathConstructor.java,v 1.1 2006-07-03 13:33:09
 *          amcveigh Exp $
 */
public abstract class CubicToQuadPathConstructor extends AbstractPathConstructor
{
  ...
  {
    quadratify(new Point2D.Double(currentX, currentY), new Point2D.Double(x1, y1), new Point2D.Double(x2, y2),
  ...
  static class Test extends CubicToQuadPathConstructor
  {
    ...
    {
      System.out
          .println("Quad: (" + currentX + ", " + currentY + ") (" + x1 + ", " + y1 + ") (" + x2 + ", " + y2 + ")");
      currentX = x2;
      currentY = y2;
    }
