...
/**
 * This class allows MouseEvents from the three buttons to be routed to three
 * MouseInputListeners. The MouseEvents generated for these listeners always
 * have Button1 in their event.
 * 
 * @author Mark Donszelmann
 * @version $Id: MouseInputRouter.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 * @status NOT TESTED
 */
public class MouseInputRouter implements MouseInputListener
{
  ...
  private MouseEvent convertMouseEvent(MouseEvent event)
  {
    ...
    return new MouseEvent(event.getComponent(), event.getID(), event.getWhen(), modifiers, event.getX(), event.getY(),
