 ...
 * literally.
 * 
 * You may add extensions with or without the leading dot. The comparison always
 * uses the leading dot.
 * 
 ...
 * @version $Id: ExtensionFileFilter.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 */
public class ExtensionFileFilter extends FileFilter
{
  ...
  /**
   * Returns the extension portion of the files name (if part of this file
   * filter).
   * 
