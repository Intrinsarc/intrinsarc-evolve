...
public class TablePrinter implements Pageable, Printable
{
   ...
   * 
   * @param model
   *          The table model to print
   * @param pf
   *          The page format to use for printing
   * @param headerFont
   *          The font to be used for the table header
   * @param cellFont
   *          The font to be used for the cells in the body of the table.
   * @param frc
   *          The font render context for the printing device
   */
   ...
   *          The table model to print
   * @param title
   *          The title to use for the print job
   * @param pf
   *          The page format to use for printing
   * @param headerFont
   *          The font to be used for the table header
   ...
   *          The font render context for the printing device
   */
  public TablePrinter(TableModel model, String title, PageFormat pf, Font headerFont, Font cellFont,
  ...
  public int print(Graphics g, PageFormat pf, int page)
  {
    ...
    String footer = "Page " + (page + 1) + " of " + nPages; // +"
                                                            // header="+headerFont+"
                                                            // cell="+cellFont;
  ...
  private void calculateTableSize(PageFormat pf, FontRenderContext frc)
  {
    ...
    double effectiveHeight = height - headerHeight - 6 - rowHeight; // leave
                                                                    // room for
                                                                    // header
