 ...
 * @version $Id: AnimatedCompoundEdit.java,v 1.1 2006-07-03 13:33:13 amcveigh
 *          Exp $
 */
public class AnimatedCompoundEdit extends CompoundEdit implements DoableEdit, LinkableEdit
{
  ...
  /**
   * Create an AnimatedCompoundEdit that still needs to be "redone".
   */
  ...
  /**
   * Create an AnimatedCompoundEdit that can be in either "done" or "undone"
   * state.
   */
  ...
  /**
   * Sends <code>undo</code> to all contained <code>LinkableEdits</code> in
  ...
  /**
   * Sends <code>redo</code> to all contained <code>LinkableEdit</code>s in
  ...
  /**
   * Sends <code>die</code> to each subedit, in the reverse of the order that
   * they were added.
   */
  public void die()
  {
  ...
  public boolean addEdit(UndoableEdit edit)
  {
    if (edit instanceof LinkableEdit)
      return addEdit((LinkableEdit) edit);
    return false;
  }

  /**
   * If this edit is <code>inProgress</code>, accepts <code>anEdit</code>
   * and returns true.
   * 
   * <p>
   ...
   * <code>anEdit</code> is given a chance to <code>replaceEdit</code> the
   * last edit. If <code>anEdit</code> returns false here, it is added to
   * <code>edits</code>.
   * 
   * @param edit
  ...
  /**
   * Returns true if any of the <code>LinkableEdit</code>s in
   * <code>edits</code> do. Returns false if they all return false.
   */
  ...
  /**
   * Returns <code>getPresentationName</code> from the last
   * <code>LinkableEdit</code> added. If this edit is empty, calls super.
   */
  ...
  /**
   * Returns <code>getUndoPresentationName</code> from the last
   * <code>LinkableEdit</code> added. If edit is empty, calls super.
   */
  ...
  /**
   * Returns <code>getRedoPresentationName</code> from the last
   * <code>LinkableEdit</code> added. If edit is empty, calls super.
   */
  ...
  {
    return "AnimatedCompoundEdit '" + ((name != null) ? name : "anonymous") + "' inProgress: " + inProgress;
  }
}
