...
/**
 * A WizardPage that implements this interface can link the user to a help
 * topic. When a HasHelpPage page is showing, the "Help" button will enable.
 * 
 * @see WizardPage
...
public interface HasHelpPage
{
   ...
   * This string must be one of the XML targets. (This is a cheesy adaptation of
