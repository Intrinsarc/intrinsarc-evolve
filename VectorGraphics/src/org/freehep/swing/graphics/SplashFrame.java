...
/**
 * Displays a particular image in a separate frame for a given period of time,
 * then destroys the frame.
 * 
 * @author Charles Loomis
 * @version $Id: SplashFrame.java,v 1.1 2009-03-04 22:46:55 andrew Exp $
 */
public class SplashFrame extends JDialog implements Runnable
{
  ...
  /**
   * The default time (in milliseconds) to wait before disposing of the
   * SplashScreen.
   */
  ...
  /**
   * This routine just waits for the given time and then disposes of the
   * SplashFrame.
   */
  public void run()
  {
