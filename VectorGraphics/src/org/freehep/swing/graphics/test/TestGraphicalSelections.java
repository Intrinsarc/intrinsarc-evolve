...
public class TestGraphicalSelections extends JFrame
{
  ...
  class TestPanel extends JPanel implements GraphicalSelectionListener
  {

    /**
     * Flag to indicate whether the transform or the selection component of the
     * GraphicalSelectionEvent should be tested.
     */
    private boolean checkTransform;

    /**
     * Flag indicating whether to transform the shapes or to set the
     * transformation of the Graphics context.
     */
    ...
    /**
     * The outline of the selection. For a point, create a small diamond
    ...
    /**
     * Temporary array used to create the test polygons. (x-coord.)
     */
    int[] xval = new int[4];

    /**
     * Temporary array used to create the test polygons. (y-coord.)
     */
    int[] yval = new int[4];
    ...
    /**
     * Constructor sets up the various geometrical shapes needed for this test.
     */
    public TestPanel()
    {
    ...
    public void graphicalSelectionMade(GraphicalSelectionEvent gsEvent)
    {
      ...
      if (gsEvent instanceof RegionSelectionEvent)
      {
        ...
        if (gsEvent instanceof PointSelectionEvent)
        {
