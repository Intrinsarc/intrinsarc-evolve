...
/**
 * A panel which selects a slice of the window in the x-direction. That is, it
 * selects a rectangular region with a height equal to the full height of the
 * window and with an adjustable width.
 * 
 * @author Charles Loomis
 * @author Mark Donszelmann
 * @version $Id: XSliceSelectionPanel.java,v 1.1 2006-07-03 13:33:26 amcveigh
 *          Exp $
 */
public class XSliceSelectionPanel extends AbstractRegionSelectionPanel
{
  ...
  /**
   * Return the number of control points 6---the four corners and the
   * centerpoints of the two sides parallel to the y-axis.
   * 
  ...
  public void updateActiveControlPoint(int x, int y)
  {
    ...
    // active.
    if (activeCtrlPt == 0 || activeCtrlPt == 3 || activeCtrlPt == 4)
    {
      ...
      if (activeCtrlPt == 1 || activeCtrlPt == 2 || activeCtrlPt == 5)
      {
  ...
  {
    return (visible) && (xCtrlPts[4] != xCtrlPts[5]) && (yCtrlPts[0] != yCtrlPts[3]);
  }
