...
/**
 * Selects a rectangular screen region. The sides of the rectangle are parallel
 * to the x and y-axes.
 * 
 * @author Charles Loomis
 * @author Mark Donszelmann
 * @version $Id: RectangularSelectionPanel.java,v 1.1 2006-07-03 13:33:26
 *          amcveigh Exp $
 */
public class RectangularSelectionPanel extends AbstractRegionSelectionPanel
{
  ...
  public Cursor getControlPointCursor(int index)
  {
    ...
    {
      int k = (index + 2) % 4;
      return compassCursor("Resize", xCtrlPts[index] - xCtrlPts[k], yCtrlPts[index] - yCtrlPts[k], 4, true);
    }
   ...
   * 
   * @param x
   *          x-coordinate (in pixels) of the starting point
   * @param y
   *          y-coordinate (in pixels) fo the starting point
   */
  ...
  /**
   * Determine if the selection is valid. Return false if the area is zero.
   */
