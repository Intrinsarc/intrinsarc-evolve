 ...
 * @version $Id: ParallelogramSelectionPanel.java,v 1.1 2006-07-03 13:33:26
 *          amcveigh Exp $
 */
public class ParallelogramSelectionPanel extends AbstractRegionSelectionPanel
{

  /**
   * The initial starting width (in pixels) of the first and last sides.
   */
  ...
  /**
   * The number of control points is 6 for the parallelogram. The four corners
   * and two at the centerpoints of the first and last sides.
   * 
  ...
  public Cursor getControlPointCursor(int index)
  {
    ...
    return compassCursor("Rotation", xCtrlPts[index] - xCtrlPts[k], yCtrlPts[index] - yCtrlPts[k], 8, true);
  }

  /**
   * Initialize the control points for this selection given the initial starting
   * point (x,y).
   * 
   * @param x
  ...
  /**
   * Make the affine transform which corresponds to this paralleogram-shaped
   * selection.
   * 
   ...
   * It is valid only if the region has a non-zero area.
   * 
