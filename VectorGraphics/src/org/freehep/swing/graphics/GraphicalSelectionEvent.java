...
/**
 * GraphicalSelectionEvent is an event which is generated when an user makes a
 * graphical selection. This event contains information about the source, the
 * type of selection which was made, and the selection type.
 * 
 * @author Charles Loomis
 * @version $Id: GraphicalSelectionEvent.java,v 1.1 2006-07-03 13:33:26 amcveigh
 *          Exp $
 */
public class GraphicalSelectionEvent extends java.util.EventObject
{
  ...
  /**
   * This action code indicates that the view should be zoomed with the given
  ...
  /**
   * This indicates that the selection should be used to select event objects
   * and that these objects should be selected in addition to any previously
   * selected objects.
   */
  ...
  /**
   * This indicates that the selection should be used to select event objects
   * and that these objects should be deselected.
   */
  ...
  /**
   * This indicates that the component should switch to the previous selection
   * mode.
   */
  final static public int PREVIOUS_MODE = 11;

  /**
   * This indicates that the component should switch to the default selection
   * mode.
   */
  ...
  /**
   * The associated AffineTransform to be used if zooming into the selected
   * region is desired.
   */
   ...
   * @param actionCode
   *          integer giving action to be done
   * @param transform
   *          an AffineTransform which will, for example, zoom into a selected
   *          region
   */
  ...
  /**
   * Return an AffineTransform which is appropriate for this selection. For a
   * point, the transform might center the display on this point. For a region,
   * the transform might zoom into the selected region.
   * 
