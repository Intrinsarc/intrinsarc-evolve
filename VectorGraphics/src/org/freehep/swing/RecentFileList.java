...
/**
 * A class for maintaining a "Recent File List". The recent file list can be
 * stored between program invocations in a properties file. One or more
 * RecentFileLists can easily be embedded in a JMenu.
 * 
 * @author Tony Johnson (tonyj@slac.stanford.edu)
 * @version $Id: RecentFileList.java,v 1.1 2009-03-04 22:46:59 andrew Exp $
 */
public class RecentFileList implements ActionListener
{
  ...
  /**
   * Create a recent file list. The type parameter is used to prefix entries in
   * the properties file, so that multiple RecentFileLists can be used in an
   * application.
   * 
   * @param type
   *          The prefix to use
  ...
  /**
   * An action event is fired when the user selects one of the files from a
   * menu. The "actionCommand" in the event will be set to the name of the
   * selected file.
   */
  ...
  /**
   * Adds the recent file list to a menu. The files will be added at the end of
   * the menu, with a separator before the files (if there are >0 files in the
   * list)
   */
