...
public class ImageTest extends JFrame
{
  ...
  String cursors[] = {"ParallelogramCursor", "PointCursor", "RectangularCursor", "RotatedRectangleCursor",
      "SquareCursor", "XSkewCursor", "YSkewCursor", "RotationCursor", "NotFoundCursor"};

  String selections[] = {"Parallelogram", "Point", "Rectangular", "RotatedRectangle", "Square", "XSkew", "YSkew",
      "Rotation", "NotFound"};
