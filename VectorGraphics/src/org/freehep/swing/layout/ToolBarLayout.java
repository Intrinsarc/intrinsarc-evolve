...
/**
 * A ToolbarLayout arranges components in a left-to-right flow, much like the
 * FlowLayout which is supplied with the JDK. However, it fixes the problem with
 * the FlowLayout that occurs when a FlowLayout is for a North aligned component
 * of a BorderLayout--namely, that if the window is shrunk so that some of the
 * components within the FlowLayout wrap to the next line the component does not
 * grow in height to support this wrapping. This bug was caused by the library
 * designers using the preferred size in recalculating, not the size which is
 * determined by the window width. As such, the flow layout would always want to
 * be the height of one row.
 * 
 * A ToolbarLayout lets each component assume its natural (preferred) size.
 * 
 * NOTE: This class was initially a subclass of FlowLayout, but we encountered
 * problems using that approach.
 * 
 * @version $Id: ToolBarLayout.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
...
public class ToolBarLayout implements LayoutManager
{
  ...
  /**
   * Constructs a new ToolbarLayout with a left alignment and a default 5-unit
  ...
  /**
   * Constructs a new ToolbarLayout with the specified alignment and a default
   * 5-unit horizontal and vertical gap. The value of the alignment argument
   * must be one of <code>ToolbarLayout.LEFT</code>,
  ...
  /**
   * Creates a new ToolbarLayout with the indicated alignment and the indicated
   * horizontal and vertical gaps.
   * <p>
   * The value of the alignment argument must be one of
   * <code>ToolbarLayout.LEFT</code>, <code>ToolbarLayout.RIGHT</code>, or
   * <code>ToolbarLayout.CENTER</code>.
   * 
   * @param align
   *          the alignment value.
   * @param hgap
   ...
   * and <code>ToolbarLayout.CENTER</code>.
   * 
   * @param align
   *          the alignment value.
   * @see #getAlignment
  ...
  /**
   * Adds the specified component to the layout. Sets the orientation to be
   * horizontal.
   * 
   * @param name
   ...
   * the specified target container. This method is the difference between
   * ToolbarLayout and FlowLayout.
   * 
   * @param target
   ...
   * size by reshaping the components in the target container in order to
   * satisfy the constraints of this <code>ToolbarLayout</code> object.
   * 
   * @param target
  ...
  public void layoutContainer(Container target)
  {
    ...
    {
      Insets insets = target.getInsets();
      int maxwidth = target.getSize().width - (insets.left + insets.right + hgap * 2);// JDK1.2
                                                                                      // porting:
                                                                                      // replace
                                                                                      // with
                                                                                      // getWidth()
  ...
  /**
   * Returns a string representation of this <code>ToolbarLayout</code> object
   * and its values.
   * 
