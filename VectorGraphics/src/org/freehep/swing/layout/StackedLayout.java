...
/**
 * This layout manager places all of the components the same size and places
 * them at the same position. This is an appropriate layout manager for a
 * JLayeredPane.
 * 
 * @author Charles Loomis
 * @version $Id: StackedLayout.java,v 1.1 2009-03-04 22:47:00 andrew Exp $
 */
...
public class StackedLayout implements LayoutManager
{
   ...
   * method actually does nothing since the component list is obtained from the
   * container directly.)
   * 
   * @param name
   ...
   * nothing since the component list is obtained from the container directly.)
   * 
   * @param comp
