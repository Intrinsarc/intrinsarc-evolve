...
/**
 * Lays out components within a Container such that each component takes a fixed
 * percentage of the size.
 * 
 * Each Component added to the Container must have a Constraint object that
 * specifies what proportion of the container it will fill. The Component will
 * be stretched to fill exactly that percentage.
 * 
 * @see Constraint
 */
public class PercentLayout implements LayoutManager2
{
  ...
  public static class Constraint
  {
     ...
     * 
     * @param x
     *          The X position of the top left corner of the component (0-100)
     * @param y
     *          The Y position of the top left corner of the component (0-100)
     * @param width
     *          The percentage width of the component (0-100)
     * @param height
