  ...
  private List<PackageViewSmartMenuItemMaker> menuItemMakers;
	...
	private class PackageViewRegistryFacetImpl implements PackageViewRegistryFacet
	{
      ...
      GlobalDiagramRegistry.registry.enforceMaxUnmodifiedUnviewedDiagramsLimit();
		...
		/**
		 * @see com.intrinsarc.evolve.packageview.base.PackageViewRegistryFacet#aboutToClose()
		 */
		...
		/**
		 * @see com.intrinsarc.evolve.packageview.base.PackageViewRegistryFacet#haveFocus(ReusableDiagramViewFacet)
		 */
		...
		/**
		 * @see com.intrinsarc.evolve.packageview.base.PackageViewRegistryFacet#reattachToCoordinator()
		 */
