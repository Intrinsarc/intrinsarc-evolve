...
public class ClipboardViewContextGem
{
  ...
  private static final int sidePad = 4;
    ...
    private JMenuItem getCopyAsImageItem(final DiagramViewFacet diagramView)
		...
		/**
		 * @see com.hopstepjump.jumble.guibase.ReusableDiagramViewContextFacet#haveClosed(ReusableDiagramViewFacet)
		 */
		...
		/**
		 * @see com.hopstepjump.jumble.guibase.ReusableDiagramViewContextFacet#haveFocus(ReusableDiagramViewFacet)
		 */
