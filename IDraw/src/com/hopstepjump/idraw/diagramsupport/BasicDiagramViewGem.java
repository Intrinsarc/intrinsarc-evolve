  ...
  private void syncWithDiagram(boolean determineAdornments)
	...
	private class DiagramListenerFacetImpl implements DiagramListenerFacet
	{
      ...
      if (adorners != null)
		...
		/**
		 * @see com.hopstepjump.idraw.foundation.DiagramListenerFacet#refreshViewAttributes()
		 */
	...
	private class BasicDiagramViewFacetImpl implements BasicDiagramViewFacet
	{
		...
		/**
		 * @see com.hopstepjump.idraw.diagramsupport.BasicDiagramViewFacet#getDiagramViewFacet()
		 */
		public DiagramViewFacet getDiagramViewFacet()
		{
			return diagramViewFacet;
		...
		/**
		 * @see com.hopstepjump.idraw.diagramsupport.BasicDiagramViewFacet#requestFocus()
		 */
	...
	{ 
      ...
      canvas.requestFocus();
		...
		/**
		 * @see com.hopstepjump.idraw.foundation.DiagramFacet#makeContextMenu(DiagramViewFacet, ToolCoordinatorFacet, boolean)
		 */
		...
		/**
		 * @see com.hopstepjump.idraw.foundation.DiagramFacet#makeMiddleButtonCommand()
		 */
		...
		/**
		 * @see com.hopstepjump.idraw.foundation.DiagramViewFacet#isUsingTools()
		 */
		...
		/**
		 * @see com.hopstepjump.idraw.foundation.DiagramViewFacet#getDrawBounds()
		 */
		...
		/**
		 * @see com.hopstepjump.idraw.foundation.DiagramViewFacet#getCursorPoint()
		 */
