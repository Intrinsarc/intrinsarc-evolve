...
import com.intrinsarc.idraw.arcfacilities.adjust.*;
...
public final class BasicArcFigureGem implements Gem
{
  ...
  private class ClipboardFacetImpl implements ClipboardFacet
  {
    ...
    /**
     * @see com.intrinsarc.idraw.foundation.ClipboardFacet#addIncludedInCopy(Set, FigureChosenFacet, boolean)
     */
  ...
  {    
    ...
    private AnchorPreviewFacet getPreviewFigureForToolLinkable(PreviewCacheFacet previewFigures, AnchorFacet initial)
    {
  	...
  	/**
  	 * @see com.intrinsarc.idraw.foundation.FigureFacet#formViewUpdateCommandAfterSubjectChanged(boolean)
  	 */
  	...
  	/**
  	 * @see com.intrinsarc.idraw.foundation.FigureFacet#middleButtonPressed(ToolCoordinatorFacet)
  	 */
  	...
  	/**
  	 * @see com.intrinsarc.idraw.foundation.FigureFacet#getClipboardFacet()
  	 */
