...
import java.awt.*;
/*
 * http://forums.sun.com/thread.jspa?forumID=57&threadID=645173
 * taken from the sun forums...
 * 
 * @(#)VerticalGridLayout.java	1.35 03/01/23
 *
...
public class VerticalGridLayout implements LayoutManager, java.io.Serializable {
     ...
     * @see       java.awt.VerticalGridLayout#minimumLayoutSize
...
//	}
  	if (ncols > 0) {
  	    nrows = (ncomponents + ncols - 1) / ncols;
		if (nrows == 1) ncols = ncomponents; // this limits the width
  	} else {
   	    ncols = (ncomponents + nrows - 1) / nrows;
		if (ncols == 1) nrows = ncomponents;  // this limits the height
  	}
	int w = 0;
	int h = 0;
     ...
     *                      subcomponents of the specified container
     * @see         java.awt.VerticalGridLayout#preferredLayoutSize
	...
	int ncols = cols;
  	...
  	if (ncols > 0) {
  	    nrows = (ncomponents + ncols - 1) / ncols;
		if (nrows == 1) ncols = ncomponents;
  	} else {
   	    ncols = (ncomponents + nrows - 1) / nrows;
		if (ncols == 1) nrows = ncomponents;
  	}
