 ...
 *
 * $Id: IntervalConstraintImpl.java,v 1.1 2009-03-04 23:06:41 andrew Exp $
 */
  ...
  public ValueSpecification undeleted_getSpecification() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.INTERVAL_CONSTRAINT__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.INTERVAL_CONSTRAINT__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.INTERVAL_CONSTRAINT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.INTERVAL_CONSTRAINT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.INTERVAL_CONSTRAINT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.INTERVAL_CONSTRAINT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.INTERVAL_CONSTRAINT__UUID:
				return getUuid();
			case UML2Package.INTERVAL_CONSTRAINT__TEMPLATE_BINDING:
			...
			case UML2Package.INTERVAL_CONSTRAINT__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.INTERVAL_CONSTRAINT__REVERSE_GENERALIZATIONS:
