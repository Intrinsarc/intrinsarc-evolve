 ...
 *
 * $Id: StateImpl.java,v 1.1 2009-03-04 23:06:35 andrew Exp $
 */
...
public class StateImpl extends NamespaceImpl implements State {
	...
	protected StateImpl() {
		...
		if (StateImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getConnections() {
	...
	public ConnectionPointReference createConnection() {
		...
		settable_getConnections().add(newConnection);
		return newConnection;
	}
  ...
  public Constraint undeleted_getStateInvariant() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.STATE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.STATE__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.STATE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.STATE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.STATE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.STATE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.STATE__UUID:
				return getUuid();
			case UML2Package.STATE__TEMPLATE_BINDING:
			...
			case UML2Package.STATE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.STATE__REVERSE_GENERALIZATIONS:
