 ...
 *
 * $Id: ExtensionPointImpl.java,v 1.1 2009-03-04 23:06:43 andrew Exp $
 */
...
public class ExtensionPointImpl extends RedefinableElementImpl implements ExtensionPoint {
	...
	protected ExtensionPointImpl() {
		...
		if (ExtensionPointImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public UseCase undeleted_getUseCase() {
		UseCase temp = getUseCase();
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.EXTENSION_POINT__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.EXTENSION_POINT__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.EXTENSION_POINT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.EXTENSION_POINT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.EXTENSION_POINT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.EXTENSION_POINT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.EXTENSION_POINT__UUID:
				return getUuid();
			case UML2Package.EXTENSION_POINT__TEMPLATE_BINDING:
			...
			case UML2Package.EXTENSION_POINT__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.EXTENSION_POINT__REVERSE_GENERALIZATIONS:
