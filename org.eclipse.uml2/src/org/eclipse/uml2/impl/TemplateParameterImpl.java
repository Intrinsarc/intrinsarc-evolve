 ...
 *
 * $Id: TemplateParameterImpl.java,v 1.1 2009-03-04 23:06:42 andrew Exp $
 */
...
public class TemplateParameterImpl extends ElementImpl implements TemplateParameter {
	...
	protected TemplateParameterImpl() {
		...
		if (TemplateParameterImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ParameterableElement undeleted_getParameteredElement() {
		ParameterableElement temp = getParameteredElement();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ParameterableElement undeleted_getOwnedParameteredElement() {
		ParameterableElement temp = getOwnedParameteredElement();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ParameterableElement undeleted_getDefault() {
		ParameterableElement temp = getDefault();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ParameterableElement undeleted_getOwnedDefault() {
		ParameterableElement temp = getOwnedDefault();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.TEMPLATE_PARAMETER__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.TEMPLATE_PARAMETER__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.TEMPLATE_PARAMETER__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.TEMPLATE_PARAMETER__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.TEMPLATE_PARAMETER__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.TEMPLATE_PARAMETER__UUID:
				return getUuid();
			case UML2Package.TEMPLATE_PARAMETER__SIGNATURE:
				return getSignature();
			case UML2Package.TEMPLATE_PARAMETER__PARAMETERED_ELEMENT:
