 ...
 *
 * $Id: ConnectorEndImpl.java,v 1.1 2009-03-04 23:06:39 andrew Exp $
 */
...
public class ConnectorEndImpl extends MultiplicityElementImpl implements ConnectorEnd {
	...
	protected ConnectorEndImpl() {
		...
		if (ConnectorEndImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public Property undeleted_getPartWithPort() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.CONNECTOR_END__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.CONNECTOR_END__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.CONNECTOR_END__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.CONNECTOR_END__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.CONNECTOR_END__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.CONNECTOR_END__UUID:
				return getUuid();
  ...
  {
    // doesn't look upwards on purpose
    
    boolean portDeleted = undeleted_getRole() == null || getRole().isThisDeleted();
    boolean partIsThereButDeleted = getPartWithPort() != null && undeleted_getPartWithPort() == null;
    
    return getJ_deleted() > 0 || portDeleted || partIsThereButDeleted;
  }
} //ConnectorEndImpl
