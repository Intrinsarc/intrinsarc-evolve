 ...
 *
 * $Id: SignalTriggerImpl.java,v 1.1 2009-03-04 23:06:36 andrew Exp $
 */
  ...
  public java.util.ArrayList undeleted_getSignals()
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass))
			{
				...
				case UML2Package.SIGNAL_TRIGGER__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.SIGNAL_TRIGGER__OWNED_TEMPLATE_SIGNATURE, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
	{
		if (featureID >= 0)
		{
			switch (eDerivedStructuralFeatureID(featureID, baseClass))
			{
				...
				case UML2Package.SIGNAL_TRIGGER__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.SIGNAL_TRIGGER__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve)
	{
		switch (eDerivedStructuralFeatureID(eFeature))
		{
			...
			case UML2Package.SIGNAL_TRIGGER__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.SIGNAL_TRIGGER__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.SIGNAL_TRIGGER__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.SIGNAL_TRIGGER__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.SIGNAL_TRIGGER__UUID:
				return getUuid();
			case UML2Package.SIGNAL_TRIGGER__TEMPLATE_BINDING:
			...
			case UML2Package.SIGNAL_TRIGGER__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.SIGNAL_TRIGGER__REVERSE_GENERALIZATIONS:
