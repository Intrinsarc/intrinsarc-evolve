 ...
 *
 * $Id: LiteralStringImpl.java,v 1.1 2009-03-04 23:06:38 andrew Exp $
 */
...
public class LiteralStringImpl extends LiteralSpecificationImpl implements LiteralString {
	...
	protected LiteralStringImpl() {
		...
		if (LiteralStringImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.LITERAL_STRING__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.LITERAL_STRING__OWNED_TEMPLATE_SIGNATURE, null, msgs);
				...
				case UML2Package.LITERAL_STRING__OWNING_PARAMETER:
					...
					return eBasicSetContainer(otherEnd, UML2Package.LITERAL_STRING__OWNING_PARAMETER, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.LITERAL_STRING__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.LITERAL_STRING__OWNED_ANONYMOUS_DEPENDENCIES:
					return ((InternalEList)getOwnedAnonymousDependencies()).basicRemove(otherEnd, msgs);
				case UML2Package.LITERAL_STRING__TEMPLATE_PARAMETER:
					return basicSetTemplateParameter(null, msgs);
				case UML2Package.LITERAL_STRING__OWNING_PARAMETER:
					return eBasicSetContainer(null, UML2Package.LITERAL_STRING__OWNING_PARAMETER, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.LITERAL_STRING__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.LITERAL_STRING__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.LITERAL_STRING__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.LITERAL_STRING__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.LITERAL_STRING__UUID:
				return getUuid();
			case UML2Package.LITERAL_STRING__TEMPLATE_BINDING:
			...
			case UML2Package.LITERAL_STRING__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.LITERAL_STRING__REVERSE_GENERALIZATIONS:
