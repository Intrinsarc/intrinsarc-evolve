 ...
 *
 * $Id: ValueSpecificationImpl.java,v 1.1 2009-03-04 23:06:38 andrew Exp $
 */
...
public abstract class ValueSpecificationImpl extends TypedElementImpl implements ValueSpecification {
	...
	protected ValueSpecificationImpl() {
		...
		if (ValueSpecificationImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public TemplateParameter undeleted_getOwningParameter() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.VALUE_SPECIFICATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.VALUE_SPECIFICATION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.VALUE_SPECIFICATION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.VALUE_SPECIFICATION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.VALUE_SPECIFICATION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.VALUE_SPECIFICATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.VALUE_SPECIFICATION__UUID:
				return getUuid();
			case UML2Package.VALUE_SPECIFICATION__TEMPLATE_BINDING:
			...
			case UML2Package.VALUE_SPECIFICATION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.VALUE_SPECIFICATION__REVERSE_GENERALIZATIONS:
