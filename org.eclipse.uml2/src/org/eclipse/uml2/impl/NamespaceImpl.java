 ...
 *
 * $Id: NamespaceImpl.java,v 1.1 2009-03-04 23:06:35 andrew Exp $
 */
...
public abstract class NamespaceImpl extends NamedElementImpl implements Namespace {
	...
	protected NamespaceImpl() {
		...
		if (NamespaceImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getPackageImports() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.NAMESPACE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.NAMESPACE__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.NAMESPACE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.NAMESPACE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.NAMESPACE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.NAMESPACE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.NAMESPACE__UUID:
				return getUuid();
			case UML2Package.NAMESPACE__TEMPLATE_BINDING:
			...
			case UML2Package.NAMESPACE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.NAMESPACE__REVERSE_GENERALIZATIONS:
