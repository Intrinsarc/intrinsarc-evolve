 ...
 *
 * $Id: CollaborationImpl.java,v 1.1 2009-03-04 23:06:43 andrew Exp $
 */
 ...
 *   <li>{@link org.eclipse.uml2.impl.CollaborationImpl#getDeltaDeletedAttributes <em>Delta Deleted Attributes</em>}</li>
 *   <li>{@link org.eclipse.uml2.impl.CollaborationImpl#getDeltaReplacedAttributes <em>Delta Replaced Attributes</em>}</li>
 *   <li>{@link org.eclipse.uml2.impl.CollaborationImpl#getDeltaDeletedPorts <em>Delta Deleted Ports</em>}</li>
 *   <li>{@link org.eclipse.uml2.impl.CollaborationImpl#getDeltaReplacedPorts <em>Delta Replaced Ports</em>}</li>
 *   <li>{@link org.eclipse.uml2.impl.CollaborationImpl#getDeltaDeletedConnectors <em>Delta Deleted Connectors</em>}</li>
...
public class CollaborationImpl extends BehavioredClassifierImpl implements Collaboration {
	...
	protected CollaborationImpl()
	{
		...
		if (CollaborationImpl.class.equals(getClass()))
	...
	public EList getOwnedAttributes()
	{
		if (ownedAttribute == null)
		{
			 ...
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
			 {
			 		...
			 		ownedAttribute = new com.hopstepjump.emflist.PersistentEList(Property.class, this, UML2Package.COLLABORATION__OWNED_ATTRIBUTE);
			 		return ownedAttribute;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(Property.class, this, UML2Package.COLLABORATION__OWNED_ATTRIBUTE);
		}      
		return ownedAttribute;
	}
  ...
  public java.util.ArrayList undeleted_getOwnedAttributes()
	...
	public EList getOwnedConnectors()
	{
		if (ownedConnector == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		ownedConnector = new com.hopstepjump.emflist.PersistentEList(Connector.class, this, UML2Package.COLLABORATION__OWNED_CONNECTOR);
			 		return ownedConnector;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(Connector.class, this, UML2Package.COLLABORATION__OWNED_CONNECTOR);
		}      
		return ownedConnector;
	}
  ...
  public java.util.ArrayList undeleted_getOwnedConnectors()
	...
	public EList getDeltaDeletedAttributes()
	{
		if (deltaDeletedAttributes == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaDeletedAttributes = new com.hopstepjump.emflist.PersistentEList(DeltaDeletedAttribute.class, this, UML2Package.COLLABORATION__DELTA_DELETED_ATTRIBUTES);
			 		return deltaDeletedAttributes;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaDeletedAttribute.class, this, UML2Package.COLLABORATION__DELTA_DELETED_ATTRIBUTES);
		}      
		return deltaDeletedAttributes;
	}
	...
	public DeltaDeletedAttribute createDeltaDeletedAttributes(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_DELETED_ATTRIBUTES, null, newDeltaDeletedAttributes));
		}
	...
	public EList getDeltaReplacedAttributes()
	{
		if (deltaReplacedAttributes == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaReplacedAttributes = new com.hopstepjump.emflist.PersistentEList(DeltaReplacedAttribute.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_ATTRIBUTES);
			 		return deltaReplacedAttributes;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaReplacedAttribute.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_ATTRIBUTES);
		}      
		return deltaReplacedAttributes;
	}
	...
	public DeltaReplacedAttribute createDeltaReplacedAttributes(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_REPLACED_ATTRIBUTES, null, newDeltaReplacedAttributes));
		}
	...
	public EList getDeltaDeletedPorts()
	{
		if (deltaDeletedPorts == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaDeletedPorts = new com.hopstepjump.emflist.PersistentEList(DeltaDeletedPort.class, this, UML2Package.COLLABORATION__DELTA_DELETED_PORTS);
			 		return deltaDeletedPorts;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaDeletedPort.class, this, UML2Package.COLLABORATION__DELTA_DELETED_PORTS);
		}      
		return deltaDeletedPorts;
	}
	...
	public DeltaDeletedPort createDeltaDeletedPorts(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_DELETED_PORTS, null, newDeltaDeletedPorts));
		}
	...
	public EList getDeltaReplacedPorts()
	{
		if (deltaReplacedPorts == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaReplacedPorts = new com.hopstepjump.emflist.PersistentEList(DeltaReplacedPort.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_PORTS);
			 		return deltaReplacedPorts;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaReplacedPort.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_PORTS);
		}      
		return deltaReplacedPorts;
	}
	...
	public DeltaReplacedPort createDeltaReplacedPorts(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_REPLACED_PORTS, null, newDeltaReplacedPorts));
		}
	...
	public EList getDeltaDeletedConnectors()
	{
		if (deltaDeletedConnectors == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaDeletedConnectors = new com.hopstepjump.emflist.PersistentEList(DeltaDeletedConnector.class, this, UML2Package.COLLABORATION__DELTA_DELETED_CONNECTORS);
			 		return deltaDeletedConnectors;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaDeletedConnector.class, this, UML2Package.COLLABORATION__DELTA_DELETED_CONNECTORS);
		}      
		return deltaDeletedConnectors;
	}
	...
	public DeltaDeletedConnector createDeltaDeletedConnectors(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_DELETED_CONNECTORS, null, newDeltaDeletedConnectors));
		}
	...
	public EList getDeltaReplacedConnectors()
	{
		if (deltaReplacedConnectors == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaReplacedConnectors = new com.hopstepjump.emflist.PersistentEList(DeltaReplacedConnector.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_CONNECTORS);
			 		return deltaReplacedConnectors;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaReplacedConnector.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_CONNECTORS);
		}      
		return deltaReplacedConnectors;
	}
	...
	public DeltaReplacedConnector createDeltaReplacedConnectors(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_REPLACED_CONNECTORS, null, newDeltaReplacedConnectors));
		}
	...
	public EList getDeltaDeletedOperations()
	{
		if (deltaDeletedOperations == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaDeletedOperations = new com.hopstepjump.emflist.PersistentEList(DeltaDeletedOperation.class, this, UML2Package.COLLABORATION__DELTA_DELETED_OPERATIONS);
			 		return deltaDeletedOperations;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaDeletedOperation.class, this, UML2Package.COLLABORATION__DELTA_DELETED_OPERATIONS);
		}      
		return deltaDeletedOperations;
	}
	...
	public DeltaDeletedOperation createDeltaDeletedOperations(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_DELETED_OPERATIONS, null, newDeltaDeletedOperations));
		}
	...
	public EList getDeltaReplacedOperations()
	{
		if (deltaReplacedOperations == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		deltaReplacedOperations = new com.hopstepjump.emflist.PersistentEList(DeltaReplacedOperation.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_OPERATIONS);
			 		return deltaReplacedOperations;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(DeltaReplacedOperation.class, this, UML2Package.COLLABORATION__DELTA_REPLACED_OPERATIONS);
		}      
		return deltaReplacedOperations;
	}
	...
	public DeltaReplacedOperation createDeltaReplacedOperations(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.COLLABORATION__DELTA_REPLACED_OPERATIONS, null, newDeltaReplacedOperations));
		}
	...
	public EList getCollaborationRoles()
	{
		if (collaborationRole == null)
		{
			 ...
			 {
			 		// create the list lazily...
			 		collaborationRole = new com.hopstepjump.emflist.PersistentEList(ConnectableElement.class, this, UML2Package.COLLABORATION__COLLABORATION_ROLE);
			 		return collaborationRole;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(ConnectableElement.class, this, UML2Package.COLLABORATION__COLLABORATION_ROLE);
		}      
		return collaborationRole;
	}
  ...
  public java.util.ArrayList undeleted_getCollaborationRoles()
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
	{
		if (featureID >= 0)
		{
			switch (eDerivedStructuralFeatureID(featureID, baseClass))
			{
				...
				case UML2Package.COLLABORATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.COLLABORATION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve)
	{
		switch (eDerivedStructuralFeatureID(eFeature))
		{
			...
			case UML2Package.COLLABORATION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.COLLABORATION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.COLLABORATION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.COLLABORATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.COLLABORATION__UUID:
				return getUuid();
			case UML2Package.COLLABORATION__TEMPLATE_BINDING:
			...
			case UML2Package.COLLABORATION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.COLLABORATION__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.COLLABORATION__IS_RETIRED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass)
	{
		if (baseClass == StructuredClassifier.class)
		{
			switch (derivedFeatureID)
			{
				...
				case UML2Package.COLLABORATION__DELTA_DELETED_ATTRIBUTES: return UML2Package.STRUCTURED_CLASSIFIER__DELTA_DELETED_ATTRIBUTES;
				case UML2Package.COLLABORATION__DELTA_REPLACED_ATTRIBUTES: return UML2Package.STRUCTURED_CLASSIFIER__DELTA_REPLACED_ATTRIBUTES;
				case UML2Package.COLLABORATION__DELTA_DELETED_PORTS: return UML2Package.STRUCTURED_CLASSIFIER__DELTA_DELETED_PORTS;
				case UML2Package.COLLABORATION__DELTA_REPLACED_PORTS: return UML2Package.STRUCTURED_CLASSIFIER__DELTA_REPLACED_PORTS;
				case UML2Package.COLLABORATION__DELTA_DELETED_CONNECTORS: return UML2Package.STRUCTURED_CLASSIFIER__DELTA_DELETED_CONNECTORS;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass)
	{
		if (baseClass == StructuredClassifier.class)
		{
			switch (baseFeatureID)
			{
				...
				case UML2Package.STRUCTURED_CLASSIFIER__DELTA_DELETED_ATTRIBUTES: return UML2Package.COLLABORATION__DELTA_DELETED_ATTRIBUTES;
				case UML2Package.STRUCTURED_CLASSIFIER__DELTA_REPLACED_ATTRIBUTES: return UML2Package.COLLABORATION__DELTA_REPLACED_ATTRIBUTES;
				case UML2Package.STRUCTURED_CLASSIFIER__DELTA_DELETED_PORTS: return UML2Package.COLLABORATION__DELTA_DELETED_PORTS;
				case UML2Package.STRUCTURED_CLASSIFIER__DELTA_REPLACED_PORTS: return UML2Package.COLLABORATION__DELTA_REPLACED_PORTS;
				case UML2Package.STRUCTURED_CLASSIFIER__DELTA_DELETED_CONNECTORS: return UML2Package.COLLABORATION__DELTA_DELETED_CONNECTORS;
