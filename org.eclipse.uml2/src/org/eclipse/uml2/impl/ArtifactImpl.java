 ...
 *
 * $Id: ArtifactImpl.java,v 1.1 2009-03-04 23:06:43 andrew Exp $
 */
...
public class ArtifactImpl extends ClassifierImpl implements Artifact {
	...
	protected ArtifactImpl() {
		...
		if (ArtifactImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getNestedArtifacts() {
	...
	public Artifact createNestedArtifact(EClass eClass) {
		...
		settable_getNestedArtifacts().add(newNestedArtifact);
  ...
  public java.util.ArrayList undeleted_getManifestations() {
	...
	public Manifestation createManifestation() {
		...
		settable_getManifestations().add(newManifestation);
		return newManifestation;
	}
  ...
  public java.util.ArrayList undeleted_getClientDependencies() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ARTIFACT__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.ARTIFACT__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.ARTIFACT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.ARTIFACT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.ARTIFACT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.ARTIFACT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.ARTIFACT__UUID:
				return getUuid();
			case UML2Package.ARTIFACT__TEMPLATE_BINDING:
			...
			case UML2Package.ARTIFACT__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.ARTIFACT__REVERSE_GENERALIZATIONS:
