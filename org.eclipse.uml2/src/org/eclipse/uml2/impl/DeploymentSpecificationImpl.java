 ...
 *
 * $Id: DeploymentSpecificationImpl.java,v 1.1 2009-03-04 23:06:42 andrew Exp $
 */
...
public class DeploymentSpecificationImpl extends ArtifactImpl implements DeploymentSpecification {
	...
	protected DeploymentSpecificationImpl() {
		...
		if (DeploymentSpecificationImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.DEPLOYMENT_SPECIFICATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.DEPLOYMENT_SPECIFICATION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.DEPLOYMENT_SPECIFICATION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.DEPLOYMENT_SPECIFICATION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.DEPLOYMENT_SPECIFICATION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.DEPLOYMENT_SPECIFICATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.DEPLOYMENT_SPECIFICATION__UUID:
				return getUuid();
			case UML2Package.DEPLOYMENT_SPECIFICATION__TEMPLATE_BINDING:
			...
			case UML2Package.DEPLOYMENT_SPECIFICATION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.DEPLOYMENT_SPECIFICATION__REVERSE_GENERALIZATIONS:
