 ...
 *
 * $Id: OperationImpl.java,v 1.1 2009-03-04 23:06:40 andrew Exp $
 */
...
public class OperationImpl extends BehavioralFeatureImpl implements Operation {
	...
	protected OperationImpl() {
		...
		if (OperationImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public TemplateParameter undeleted_getOwningParameter() {
	...
	public EList getOwnedParameters() {
		if (formalParameter == null) {
			return new PersistentEList(Parameter.class, this, UML2Package.OPERATION__OWNED_PARAMETER, UML2Package.PARAMETER__OPERATION);
		}
  ...
  public EList settable_getOwnedParameters() {
    if (formalParameter == null) {
      formalParameter = new PersistentEList(Parameter.class, this, UML2Package.OPERATION__OWNED_PARAMETER, UML2Package.PARAMETER__OPERATION);
    }
    return formalParameter;
  }
  ...
  public Constraint undeleted_getBodyCondition() {
	...
	public EList getRaisedExceptions() {
		...
		if (null == raisedException) {
			return new EObjectResolvingEList(Type.class, this, UML2Package.OPERATION__RAISED_EXCEPTION);
		}
  ...
  public Type undeleted_getType() {
    if (type() != null && type().getJ_deleted() == 0)
      return type();
    return null;
  }
  ...
  public java.util.ArrayList undeleted_getOwnedRules() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.OPERATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.OPERATION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.OPERATION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.OPERATION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.OPERATION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.OPERATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.OPERATION__UUID:
				return getUuid();
			case UML2Package.OPERATION__TEMPLATE_BINDING:
			...
			case UML2Package.OPERATION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.OPERATION__REVERSE_GENERALIZATIONS:
