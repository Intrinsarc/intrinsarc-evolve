 ...
 *
 * $Id: UseCaseImpl.java,v 1.1 2009-03-04 23:06:38 andrew Exp $
 */
...
public class UseCaseImpl extends BehavioredClassifierImpl implements UseCase {
	...
	protected UseCaseImpl() {
		...
		if (UseCaseImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getIncludes() {
	...
	public Include createInclude() {
		...
		settable_getIncludes().add(newInclude);
		return newInclude;
	}
  ...
  public java.util.ArrayList undeleted_getExtends() {
	...
	public Extend createExtend() {
		...
		settable_getExtends().add(newExtend);
		return newExtend;
	}
  ...
  public java.util.ArrayList undeleted_getExtensionPoints() {
	...
	public ExtensionPoint createExtensionPoint() {
		...
		settable_getExtensionPoints().add(newExtensionPoint);
		return newExtensionPoint;
	}
  ...
  public java.util.ArrayList undeleted_getSubjects() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.USE_CASE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.USE_CASE__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.USE_CASE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.USE_CASE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.USE_CASE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.USE_CASE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.USE_CASE__UUID:
				return getUuid();
			case UML2Package.USE_CASE__TEMPLATE_BINDING:
			...
			case UML2Package.USE_CASE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.USE_CASE__REVERSE_GENERALIZATIONS:
