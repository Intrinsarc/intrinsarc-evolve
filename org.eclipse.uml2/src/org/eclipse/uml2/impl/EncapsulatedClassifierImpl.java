 ...
 *
 * $Id: EncapsulatedClassifierImpl.java,v 1.1 2009-03-04 23:06:39 andrew Exp $
 */
...
public abstract class EncapsulatedClassifierImpl extends StructuredClassifierImpl implements EncapsulatedClassifier {
	...
	protected EncapsulatedClassifierImpl() {
		...
		if (EncapsulatedClassifierImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getOwnedPorts() {
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ENCAPSULATED_CLASSIFIER__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.ENCAPSULATED_CLASSIFIER__OWNED_TEMPLATE_SIGNATURE, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ENCAPSULATED_CLASSIFIER__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.ENCAPSULATED_CLASSIFIER__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_DELETED_ATTRIBUTES:
					return ((InternalEList)getDeltaDeletedAttributes()).basicRemove(otherEnd, msgs);
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_REPLACED_ATTRIBUTES:
					return ((InternalEList)getDeltaReplacedAttributes()).basicRemove(otherEnd, msgs);
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_DELETED_PORTS:
					return ((InternalEList)getDeltaDeletedPorts()).basicRemove(otherEnd, msgs);
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_REPLACED_PORTS:
					return ((InternalEList)getDeltaReplacedPorts()).basicRemove(otherEnd, msgs);
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_DELETED_CONNECTORS:
					return ((InternalEList)getDeltaDeletedConnectors()).basicRemove(otherEnd, msgs);
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_REPLACED_CONNECTORS:
					return ((InternalEList)getDeltaReplacedConnectors()).basicRemove(otherEnd, msgs);
				case UML2Package.ENCAPSULATED_CLASSIFIER__DELTA_DELETED_OPERATIONS:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.ENCAPSULATED_CLASSIFIER__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.ENCAPSULATED_CLASSIFIER__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.ENCAPSULATED_CLASSIFIER__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.ENCAPSULATED_CLASSIFIER__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.ENCAPSULATED_CLASSIFIER__UUID:
				return getUuid();
			case UML2Package.ENCAPSULATED_CLASSIFIER__TEMPLATE_BINDING:
			...
			case UML2Package.ENCAPSULATED_CLASSIFIER__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.ENCAPSULATED_CLASSIFIER__REVERSE_GENERALIZATIONS:
