 ...
 *
 * $Id: LinkActionImpl.java,v 1.1 2009-03-04 23:06:37 andrew Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.uml2.impl.LinkActionImpl#getEndData <em>End Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LinkActionImpl extends ActionImpl implements LinkAction {
	...
	protected LinkActionImpl() {
		...
		if (LinkActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getEndData() {
	...
	public LinkEndData createEndData(EClass eClass) {
		...
		settable_getEndData().add(newEndData);
		return newEndData;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.LINK_ACTION__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.LINK_ACTION__OWNED_TEMPLATE_SIGNATURE, null, msgs);
					return basicSetOwnedTemplateSignature((TemplateSignature)otherEnd, msgs);
				case UML2Package.LINK_ACTION__CLIENT_DEPENDENCY:
				...
				case UML2Package.LINK_ACTION__ACTIVITY:
					...
					return eBasicSetContainer(otherEnd, UML2Package.LINK_ACTION__ACTIVITY, msgs);
				case UML2Package.LINK_ACTION__IN_STRUCTURED_NODE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UML2Package.LINK_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.LINK_ACTION__IN_PARTITION:
					return ((InternalEList)getInPartitions()).basicAdd(otherEnd, msgs);
				case UML2Package.LINK_ACTION__IN_INTERRUPTIBLE_REGION:
					return ((InternalEList)getInInterruptibleRegions()).basicAdd(otherEnd, msgs);
				case UML2Package.LINK_ACTION__HANDLER:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.LINK_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.LINK_ACTION__NAME_EXPRESSION:
					return basicSetNameExpression(null, msgs);
				case UML2Package.LINK_ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.LINK_ACTION__ACTIVITY:
					return eBasicSetContainer(null, UML2Package.LINK_ACTION__ACTIVITY, msgs);
				case UML2Package.LINK_ACTION__IN_STRUCTURED_NODE:
					return eBasicSetContainer(null, UML2Package.LINK_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.LINK_ACTION__IN_PARTITION:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.LINK_ACTION__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case UML2Package.LINK_ACTION__OWNED_COMMENT:
				return getOwnedComments();
			case UML2Package.LINK_ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.LINK_ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.LINK_ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.LINK_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.LINK_ACTION__UUID:
				return getUuid();
			case UML2Package.LINK_ACTION__TEMPLATE_BINDING:
				return getTemplateBindings();
			case UML2Package.LINK_ACTION__OWNED_TEMPLATE_SIGNATURE:
				return getOwnedTemplateSignature();
			case UML2Package.LINK_ACTION__NAME:
				return getName();
			case UML2Package.LINK_ACTION__QUALIFIED_NAME:
				return getQualifiedName();
			case UML2Package.LINK_ACTION__VISIBILITY:
			...
			case UML2Package.LINK_ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.LINK_ACTION__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.LINK_ACTION__INCOMING:
				return getIncomings();
			case UML2Package.LINK_ACTION__IN_GROUP:
				return getInGroups();
			case UML2Package.LINK_ACTION__ACTIVITY:
				return getActivity();
			case UML2Package.LINK_ACTION__REDEFINED_ELEMENT:
			...
			case UML2Package.LINK_ACTION__HANDLER:
				return getHandlers();
			case UML2Package.LINK_ACTION__EFFECT:
				return getEffect();
			case UML2Package.LINK_ACTION__OUTPUT:
				return getOutputs();
