 ...
 *
 * $Id: ActivityGroupImpl.java,v 1.1 2009-03-04 23:06:44 andrew Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Activity Group</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class ActivityGroupImpl extends ElementImpl implements ActivityGroup
{
  ...
  {
    if (newActivityGroup_activity != eContainer
        || (eContainerFeatureID != UML2Package.ACTIVITY_GROUP__ACTIVITY_GROUP_ACTIVITY && newActivityGroup_activity != null))
    {
      ...
      if (newActivityGroup_activity != null)
        msgs = ((InternalEObject) newActivityGroup_activity).eInverseAdd(this, UML2Package.ACTIVITY__GROUP,
            Activity.class, msgs);
      msgs = eBasicSetContainer((InternalEObject) newActivityGroup_activity,
          UML2Package.ACTIVITY_GROUP__ACTIVITY_GROUP_ACTIVITY, msgs);
      if (msgs != null)
        msgs.dispatch();
    }
    else
      if (eNotificationRequired())
        eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.ACTIVITY_GROUP__ACTIVITY_GROUP_ACTIVITY,
            newActivityGroup_activity, newActivityGroup_activity));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ACTIVITY_GROUP__APPLIED_BASIC_STEREOTYPE_VALUES:
  ...
  public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.ACTIVITY_GROUP__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.ACTIVITY_GROUP__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.ACTIVITY_GROUP__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.ACTIVITY_GROUP__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.ACTIVITY_GROUP__UUID:
				return getUuid();
