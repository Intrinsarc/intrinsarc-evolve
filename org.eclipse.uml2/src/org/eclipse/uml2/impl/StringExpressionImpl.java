 ...
 *
 * $Id: StringExpressionImpl.java,v 1.1 2009-03-04 23:06:38 andrew Exp $
 */
...
public class StringExpressionImpl extends TemplateableElementImpl implements StringExpression {
	...
	protected StringExpressionImpl() {
		...
		if (StringExpressionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getSubExpressions() {
	...
	public StringExpression createSubExpression() {
		...
		settable_getSubExpressions().add(newSubExpression);
		return newSubExpression;
	}
  ...
  public StringExpression undeleted_getOwningExpression() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.STRING_EXPRESSION__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.STRING_EXPRESSION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.STRING_EXPRESSION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.STRING_EXPRESSION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.STRING_EXPRESSION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.STRING_EXPRESSION__UUID:
				return getUuid();
			case UML2Package.STRING_EXPRESSION__TEMPLATE_BINDING:
