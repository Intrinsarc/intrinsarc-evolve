 ...
 *
 * $Id: GeneralizationImpl.java,v 1.1 2009-03-04 23:06:37 andrew Exp $
 */
...
public class GeneralizationImpl extends DirectedRelationshipImpl implements Generalization {
  ...
  public Classifier undeleted_getGeneral() {
	...
	public void setGeneral(Classifier newGeneral) {
		...
		{
			if (oldGeneral != null && newGeneral != oldGeneral)
				oldGeneral.settable_getReverseGeneralizations().remove(this);
			newGeneral.settable_getReverseGeneralizations().add(this);
		}
	}
	...
	public EList getGeneralizationSets() {
		if (generalizationSet == null) {
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET) {
			 		...
			 		generalizationSet = new com.hopstepjump.emflist.PersistentEList(GeneralizationSet.class, this, UML2Package.GENERALIZATION__GENERALIZATION_SET, UML2Package.GENERALIZATION_SET__GENERALIZATION);
			 		return generalizationSet;
			 }
			return new com.hopstepjump.emflist.UnmodifiableEList(GeneralizationSet.class, this, UML2Package.GENERALIZATION__GENERALIZATION_SET, UML2Package.GENERALIZATION_SET__GENERALIZATION);
		}      
		return generalizationSet;
	}
  ...
  public java.util.ArrayList undeleted_getGeneralizationSets() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.GENERALIZATION__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.GENERALIZATION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.GENERALIZATION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.GENERALIZATION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.GENERALIZATION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.GENERALIZATION__UUID:
				return getUuid();
