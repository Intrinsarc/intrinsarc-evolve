 ...
 *
 * $Id: ReadLinkActionImpl.java,v 1.1 2009-03-04 23:06:44 andrew Exp $
 */
...
public class ReadLinkActionImpl extends LinkActionImpl implements ReadLinkAction {
	...
	protected ReadLinkActionImpl() {
		...
		if (ReadLinkActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public OutputPin undeleted_getResult() {
	...
	public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2Package.READ_LINK_ACTION__RESULT, oldResult, newResult);
	...
	public void setResult(OutputPin newResult) {
		if (newResult != result) {
			...
			if (result != null)
				msgs = ((InternalEObject)result).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.READ_LINK_ACTION__RESULT, null, msgs);
			if (newResult != null)
				msgs = ((InternalEObject)newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2Package.READ_LINK_ACTION__RESULT, null, msgs);
			msgs = basicSetResult(newResult, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.READ_LINK_ACTION__RESULT, newResult, newResult));
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.READ_LINK_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.READ_LINK_ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.READ_LINK_ACTION__ACTIVITY:
					return eBasicSetContainer(null, UML2Package.READ_LINK_ACTION__ACTIVITY, msgs);
				case UML2Package.READ_LINK_ACTION__IN_STRUCTURED_NODE:
					return eBasicSetContainer(null, UML2Package.READ_LINK_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.READ_LINK_ACTION__IN_PARTITION:
				...
				case UML2Package.READ_LINK_ACTION__LOCAL_POSTCONDITION:
					return ((InternalEList)getLocalPostconditions()).basicRemove(otherEnd, msgs);
				case UML2Package.READ_LINK_ACTION__END_DATA:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.READ_LINK_ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.READ_LINK_ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.READ_LINK_ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.READ_LINK_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.READ_LINK_ACTION__UUID:
				return getUuid();
			case UML2Package.READ_LINK_ACTION__TEMPLATE_BINDING:
				return getTemplateBindings();
			case UML2Package.READ_LINK_ACTION__OWNED_TEMPLATE_SIGNATURE:
				return getOwnedTemplateSignature();
			case UML2Package.READ_LINK_ACTION__NAME:
				return getName();
			case UML2Package.READ_LINK_ACTION__QUALIFIED_NAME:
				return getQualifiedName();
			case UML2Package.READ_LINK_ACTION__VISIBILITY:
			...
			case UML2Package.READ_LINK_ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.READ_LINK_ACTION__REVERSE_GENERALIZATIONS:
