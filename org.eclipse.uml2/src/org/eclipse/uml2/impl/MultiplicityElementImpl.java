 ...
 *
 * $Id: MultiplicityElementImpl.java,v 1.1 2009-03-04 23:06:39 andrew Exp $
 */
...
public abstract class MultiplicityElementImpl extends ElementImpl implements MultiplicityElement {
	...
	protected MultiplicityElementImpl() {
		...
		if (MultiplicityElementImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public ValueSpecification undeleted_getLowerValue() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.MULTIPLICITY_ELEMENT__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.MULTIPLICITY_ELEMENT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.MULTIPLICITY_ELEMENT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.MULTIPLICITY_ELEMENT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.MULTIPLICITY_ELEMENT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.MULTIPLICITY_ELEMENT__UUID:
				return getUuid();
