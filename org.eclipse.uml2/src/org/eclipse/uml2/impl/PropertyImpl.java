 ...
 *
 * $Id: PropertyImpl.java,v 1.1 2009-03-04 23:06:39 andrew Exp $
 */
 ...
 *   <li>{@link org.eclipse.uml2.impl.PropertyImpl#getOwnedAnonymousType <em>Owned Anonymous Type</em>}</li>
 *   <li>{@link org.eclipse.uml2.impl.PropertyImpl#getDefaultValues <em>Default Values</em>}</li>
...
public class PropertyImpl extends StructuralFeatureImpl implements Property {
	 ...
	 * @ordered
	 */
	protected static final int IS_DERIVED_UNION_EFLAG = 1 << 13;
	...
	/**
	 * The cached value of the '{@link #getOwnedAnonymousType() <em>Owned Anonymous Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected Type ownedAnonymousType = null;
	 ...
	 * @ordered
	 */
	protected EList defaultValues = null;
	 ...
	 * @ordered
	 */
	protected static final int IS_READ_ONLY_EFLAG = 1 << -1;
	...
	protected PropertyImpl() {
		...
		if (PropertyImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getDeployments() {
	 ...
	 * @generated
	 */
	public java.util.ArrayList undeleted_getDefaultValues() {
		java.util.ArrayList temp = new java.util.ArrayList();
	 ...
	 * @generated
	 */
	public ValueSpecification createDefaultValues(EClass eClass) {
		ValueSpecification newDefaultValues = (ValueSpecification) eClass.getEPackage().getEFactoryInstance().create(eClass);
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.PROPERTY__DEFAULT_VALUES, null, newDefaultValues));
		}
		settable_getDefaultValues().add(newDefaultValues);
	 ...
	 * @generated
	 */
	public ValueSpecification getDefaultValues(String name) {
		for (Iterator i = getDefaultValues().iterator(); i.hasNext(); ) {
			ValueSpecification defaultValues = (ValueSpecification) i.next();
			if (name.equals(defaultValues.getName())) {
				return defaultValues;
			}
		}
		return null;
	...
	public void setIsReadOnly(boolean newIsReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.PROPERTY__READ_WRITE, oldIsReadOnly, newIsReadOnly));
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public Association undeleted_getOwningAssociation() {
		Association temp = getOwningAssociation();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public java.util.ArrayList undeleted_getRedefinedProperties() {
		java.util.ArrayList temp = new java.util.ArrayList();

		if (redefinedProperty != null) {
			for (Object object : redefinedProperty) {
				org.eclipse.uml2.Element element = (org.eclipse.uml2.Element) object;
				if (!element.isThisDeleted())
					temp.add(element);
			}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public java.util.ArrayList undeleted_getSubsettedProperties() {
		java.util.ArrayList temp = new java.util.ArrayList();

		if (subsettedProperty != null) {
			for (Object object : subsettedProperty) {
				org.eclipse.uml2.Element element = (org.eclipse.uml2.Element) object;
				if (!element.isThisDeleted())
					temp.add(element);
			}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public Property undeleted_getAssociationEnd() {
		Property temp = getAssociationEnd();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
	 ...
	 * @generated
	 */
	public Type getOwnedAnonymousType() {
		return ownedAnonymousType;
	}
	 ...
	 * @generated
	 */
	public Type undeleted_getOwnedAnonymousType() {
		Type temp = getOwnedAnonymousType();
		if (temp != null && temp.isThisDeleted())
				return null;
		return temp;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwnedAnonymousType(Type newOwnedAnonymousType, NotificationChain msgs) {
		Type oldOwnedAnonymousType = ownedAnonymousType;
		ownedAnonymousType = newOwnedAnonymousType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2Package.PROPERTY__OWNED_ANONYMOUS_TYPE, oldOwnedAnonymousType, newOwnedAnonymousType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
	 ...
	 * @generated
	 */
	public void setOwnedAnonymousType(Type newOwnedAnonymousType) {
		if (newOwnedAnonymousType != ownedAnonymousType) {
			NotificationChain msgs = null;
			if (ownedAnonymousType != null)
				msgs = ((InternalEObject)ownedAnonymousType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.PROPERTY__OWNED_ANONYMOUS_TYPE, null, msgs);
			if (newOwnedAnonymousType != null)
				msgs = ((InternalEObject)newOwnedAnonymousType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2Package.PROPERTY__OWNED_ANONYMOUS_TYPE, null, msgs);
			msgs = basicSetOwnedAnonymousType(newOwnedAnonymousType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.PROPERTY__OWNED_ANONYMOUS_TYPE, newOwnedAnonymousType, newOwnedAnonymousType));
	 ...
	 * @generated
	 */
	public Type createOwnedAnonymousType(EClass eClass) {
		Type newOwnedAnonymousType = (Type) eClass.getEPackage().getEFactoryInstance().create(eClass);
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.PROPERTY__OWNED_ANONYMOUS_TYPE, null, newOwnedAnonymousType));
		}
		setOwnedAnonymousType(newOwnedAnonymousType);
		return newOwnedAnonymousType;
	}
  ...
  public java.util.ArrayList undeleted_getClientDependencies() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.PROPERTY__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.PROPERTY__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.PROPERTY__OWNED_ANONYMOUS_TYPE:
					return basicSetOwnedAnonymousType(null, msgs);
				case UML2Package.PROPERTY__DEFAULT_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.PROPERTY__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.PROPERTY__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.PROPERTY__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.PROPERTY__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.PROPERTY__UUID:
				return getUuid();
			case UML2Package.PROPERTY__TEMPLATE_BINDING:
			...
			case UML2Package.PROPERTY__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.PROPERTY__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.PROPERTY__READ_WRITE:
				return getReadWrite();
			case UML2Package.PROPERTY__TEMPLATE_PARAMETER:
