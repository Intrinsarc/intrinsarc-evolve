 ...
 *
 * $Id: ReadExtentActionImpl.java,v 1.1 2009-03-04 23:06:38 andrew Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.uml2.impl.ReadExtentActionImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.eclipse.uml2.impl.ReadExtentActionImpl#getClassifier <em>Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadExtentActionImpl extends ActionImpl implements ReadExtentAction {
	...
	protected ReadExtentActionImpl() {
		...
		if (ReadExtentActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public OutputPin undeleted_getResult() {
	...
	public void setResult(OutputPin newResult) {
		if (newResult != result) {
			...
			if (newResult != null)
				msgs = ((InternalEObject)newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2Package.READ_EXTENT_ACTION__RESULT, null, msgs);
			msgs = basicSetResult(newResult, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.READ_EXTENT_ACTION__RESULT, newResult, newResult));
  ...
  public Classifier undeleted_getClassifier() {
	...
	public void setClassifier(Classifier newClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.READ_EXTENT_ACTION__CLASSIFIER, oldClassifier, classifier));
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.READ_EXTENT_ACTION__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.READ_EXTENT_ACTION__OWNED_TEMPLATE_SIGNATURE, null, msgs);
				...
				case UML2Package.READ_EXTENT_ACTION__ACTIVITY:
					...
					return eBasicSetContainer(otherEnd, UML2Package.READ_EXTENT_ACTION__ACTIVITY, msgs);
				case UML2Package.READ_EXTENT_ACTION__IN_STRUCTURED_NODE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UML2Package.READ_EXTENT_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.READ_EXTENT_ACTION__IN_PARTITION:
					return ((InternalEList)getInPartitions()).basicAdd(otherEnd, msgs);
				case UML2Package.READ_EXTENT_ACTION__IN_INTERRUPTIBLE_REGION:
					return ((InternalEList)getInInterruptibleRegions()).basicAdd(otherEnd, msgs);
				case UML2Package.READ_EXTENT_ACTION__HANDLER:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.READ_EXTENT_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.READ_EXTENT_ACTION__NAME_EXPRESSION:
					return basicSetNameExpression(null, msgs);
				case UML2Package.READ_EXTENT_ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.READ_EXTENT_ACTION__ACTIVITY:
					return eBasicSetContainer(null, UML2Package.READ_EXTENT_ACTION__ACTIVITY, msgs);
				case UML2Package.READ_EXTENT_ACTION__IN_STRUCTURED_NODE:
					return eBasicSetContainer(null, UML2Package.READ_EXTENT_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.READ_EXTENT_ACTION__IN_PARTITION:
				...
				case UML2Package.READ_EXTENT_ACTION__LOCAL_PRECONDITION:
					return ((InternalEList)getLocalPreconditions()).basicRemove(otherEnd, msgs);
				case UML2Package.READ_EXTENT_ACTION__LOCAL_POSTCONDITION:
					return ((InternalEList)getLocalPostconditions()).basicRemove(otherEnd, msgs);
				case UML2Package.READ_EXTENT_ACTION__RESULT:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.READ_EXTENT_ACTION__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case UML2Package.READ_EXTENT_ACTION__OWNED_COMMENT:
				return getOwnedComments();
			case UML2Package.READ_EXTENT_ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.READ_EXTENT_ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.READ_EXTENT_ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.READ_EXTENT_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.READ_EXTENT_ACTION__UUID:
				return getUuid();
			case UML2Package.READ_EXTENT_ACTION__TEMPLATE_BINDING:
			...
			case UML2Package.READ_EXTENT_ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.READ_EXTENT_ACTION__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.READ_EXTENT_ACTION__INCOMING:
				return getIncomings();
			case UML2Package.READ_EXTENT_ACTION__IN_GROUP:
				return getInGroups();
			case UML2Package.READ_EXTENT_ACTION__ACTIVITY:
				return getActivity();
			case UML2Package.READ_EXTENT_ACTION__REDEFINED_ELEMENT:
			...
			case UML2Package.READ_EXTENT_ACTION__OUTPUT:
				return getOutputs();
			case UML2Package.READ_EXTENT_ACTION__INPUT:
				return getInputs();
			case UML2Package.READ_EXTENT_ACTION__CONTEXT:
