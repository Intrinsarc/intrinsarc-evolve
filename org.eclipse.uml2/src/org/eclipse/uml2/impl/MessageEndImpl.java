 ...
 *
 * $Id: MessageEndImpl.java,v 1.1 2009-03-04 23:06:42 andrew Exp $
 */
...
public abstract class MessageEndImpl extends NamedElementImpl implements MessageEnd {
	...
	protected MessageEndImpl() {
		...
		if (MessageEndImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public Message undeleted_getSendMessage() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.MESSAGE_END__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.MESSAGE_END__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.MESSAGE_END__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.MESSAGE_END__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.MESSAGE_END__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.MESSAGE_END__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.MESSAGE_END__UUID:
				return getUuid();
			case UML2Package.MESSAGE_END__TEMPLATE_BINDING:
			...
			case UML2Package.MESSAGE_END__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.MESSAGE_END__REVERSE_GENERALIZATIONS:
