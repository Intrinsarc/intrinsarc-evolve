 ...
 *
 * $Id: CallActionImpl.java,v 1.1 2009-03-04 23:06:43 andrew Exp $
 */
...
public abstract class CallActionImpl extends InvocationActionImpl implements CallAction {
	...
	protected CallActionImpl() {
		...
		if (CallActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getResults() {
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.CALL_ACTION__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.CALL_ACTION__OWNED_TEMPLATE_SIGNATURE, null, msgs);
				...
				case UML2Package.CALL_ACTION__ACTIVITY:
					...
					return eBasicSetContainer(otherEnd, UML2Package.CALL_ACTION__ACTIVITY, msgs);
				case UML2Package.CALL_ACTION__IN_STRUCTURED_NODE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UML2Package.CALL_ACTION__IN_STRUCTURED_NODE, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.CALL_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.CALL_ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.CALL_ACTION__ACTIVITY:
					return eBasicSetContainer(null, UML2Package.CALL_ACTION__ACTIVITY, msgs);
				case UML2Package.CALL_ACTION__IN_STRUCTURED_NODE:
					return eBasicSetContainer(null, UML2Package.CALL_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.CALL_ACTION__IN_PARTITION:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.CALL_ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.CALL_ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.CALL_ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.CALL_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.CALL_ACTION__UUID:
				return getUuid();
			case UML2Package.CALL_ACTION__TEMPLATE_BINDING:
			...
			case UML2Package.CALL_ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.CALL_ACTION__REVERSE_GENERALIZATIONS:
