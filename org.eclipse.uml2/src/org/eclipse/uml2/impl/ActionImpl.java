 ...
 *
 * $Id: ActionImpl.java,v 1.1 2009-03-04 23:06:36 andrew Exp $
 */
...
public class ActionImpl extends ExecutableNodeImpl implements Action {
	...
	protected ActionImpl() {
		...
		if (ActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getLocalPreconditions() {
	...
	public Constraint createLocalPrecondition(EClass eClass) {
		...
		settable_getLocalPreconditions().add(newLocalPrecondition);
  ...
  public java.util.ArrayList undeleted_getLocalPostconditions() {
	...
	public Constraint createLocalPostcondition(EClass eClass) {
		...
		settable_getLocalPostconditions().add(newLocalPostcondition);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.ACTION__UUID:
				return getUuid();
			case UML2Package.ACTION__TEMPLATE_BINDING:
			...
			case UML2Package.ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.ACTION__REVERSE_GENERALIZATIONS:
