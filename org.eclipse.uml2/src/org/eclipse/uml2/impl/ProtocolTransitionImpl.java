 ...
 *
 * $Id: ProtocolTransitionImpl.java,v 1.1 2009-03-04 23:06:43 andrew Exp $
 */
  ...
  public Constraint undeleted_getPreCondition()
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
	{
		if (featureID >= 0)
		{
			switch (eDerivedStructuralFeatureID(featureID, baseClass))
			{
				...
				case UML2Package.PROTOCOL_TRANSITION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.PROTOCOL_TRANSITION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve)
	{
		switch (eDerivedStructuralFeatureID(eFeature))
		{
			...
			case UML2Package.PROTOCOL_TRANSITION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.PROTOCOL_TRANSITION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.PROTOCOL_TRANSITION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.PROTOCOL_TRANSITION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.PROTOCOL_TRANSITION__UUID:
				return getUuid();
			case UML2Package.PROTOCOL_TRANSITION__TEMPLATE_BINDING:
			...
			case UML2Package.PROTOCOL_TRANSITION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.PROTOCOL_TRANSITION__REVERSE_GENERALIZATIONS:
