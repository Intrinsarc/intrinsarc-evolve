 ...
 *
 * $Id: InteractionFragmentImpl.java,v 1.1 2009-03-04 23:06:39 andrew Exp $
 */
...
public abstract class InteractionFragmentImpl extends NamedElementImpl implements InteractionFragment {
	...
	protected InteractionFragmentImpl() {
		...
		if (InteractionFragmentImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public EList getCovereds() {
		if (covered == null) {
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET) {
			 		...
			 		covered = new com.intrinsarc.emflist.PersistentEList(Lifeline.class, this, UML2Package.INTERACTION_FRAGMENT__COVERED, UML2Package.LIFELINE__COVERED_BY);
			 		return covered;
			 }
			return new com.intrinsarc.emflist.UnmodifiableEList(Lifeline.class, this, UML2Package.INTERACTION_FRAGMENT__COVERED, UML2Package.LIFELINE__COVERED_BY);
		}      
		return covered;
	}
  ...
  public java.util.ArrayList undeleted_getCovereds() {
	...
	public EList getGeneralOrderings() {
		if (generalOrdering == null) {
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET) {
			 		// create the list lazily...
			 		generalOrdering = new com.intrinsarc.emflist.PersistentEList(GeneralOrdering.class, this, UML2Package.INTERACTION_FRAGMENT__GENERAL_ORDERING);
			 		return generalOrdering;
			 }
			return new com.intrinsarc.emflist.UnmodifiableEList(GeneralOrdering.class, this, UML2Package.INTERACTION_FRAGMENT__GENERAL_ORDERING);
		}      
		return generalOrdering;
	}
  ...
  public InteractionOperand undeleted_getEnclosingOperand() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.INTERACTION_FRAGMENT__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.INTERACTION_FRAGMENT__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.INTERACTION_FRAGMENT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.INTERACTION_FRAGMENT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.INTERACTION_FRAGMENT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.INTERACTION_FRAGMENT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.INTERACTION_FRAGMENT__UUID:
				return getUuid();
			case UML2Package.INTERACTION_FRAGMENT__TEMPLATE_BINDING:
			...
			case UML2Package.INTERACTION_FRAGMENT__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.INTERACTION_FRAGMENT__REVERSE_GENERALIZATIONS:
