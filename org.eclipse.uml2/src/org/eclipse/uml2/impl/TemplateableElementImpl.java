 ...
 *
 * $Id: TemplateableElementImpl.java,v 1.1 2009-03-04 23:06:34 andrew Exp $
 */
...
public abstract class TemplateableElementImpl extends ElementImpl implements TemplateableElement {
  ...
  public java.util.ArrayList undeleted_getTemplateBindings() {
	...
	public TemplateBinding createTemplateBinding() {
		...
		settable_getTemplateBindings().add(newTemplateBinding);
		return newTemplateBinding;
	}
  ...
  public TemplateSignature undeleted_getOwnedTemplateSignature() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.TEMPLATEABLE_ELEMENT__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.TEMPLATEABLE_ELEMENT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.TEMPLATEABLE_ELEMENT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.TEMPLATEABLE_ELEMENT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.TEMPLATEABLE_ELEMENT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.TEMPLATEABLE_ELEMENT__UUID:
				return getUuid();
			case UML2Package.TEMPLATEABLE_ELEMENT__TEMPLATE_BINDING:
