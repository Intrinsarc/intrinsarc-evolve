 ...
 *
 * $Id: StructuralFeatureImpl.java,v 1.1 2009-03-04 23:06:40 andrew Exp $
 */
 ...
 *   <li>{@link org.eclipse.uml2.impl.StructuralFeatureImpl#getReadWrite <em>Read Write</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuralFeatureImpl extends FeatureImpl implements StructuralFeature {
	...
	/**
	 * The default value of the '{@link #getReadWrite() <em>Read Write</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getReadWrite()
	 * @generated
	 * @ordered
	 */
	protected static final PropertyAccessKind READ_WRITE_EDEFAULT = PropertyAccessKind.READ_WRITE_LITERAL;

	/**
	 * The cached value of the '{@link #getReadWrite() <em>Read Write</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getReadWrite()
	 * @generated
	 * @ordered
	 */
	protected PropertyAccessKind readWrite = READ_WRITE_EDEFAULT;
	...
	protected StructuralFeatureImpl() {
		...
		if (StructuralFeatureImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public boolean isReadOnly() {
		return readWrite.equals(PropertyAccessKind.READ_ONLY_LITERAL);
	}
	...
	public void setIsReadOnly(boolean newIsReadOnly) {
		readWrite = PropertyAccessKind.READ_ONLY_LITERAL;
	}
  ...
  public ValueSpecification undeleted_getLowerValue() {
	...
	public void setReadWrite(PropertyAccessKind newReadWrite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.STRUCTURAL_FEATURE__READ_WRITE, oldReadWrite, readWrite));
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.STRUCTURAL_FEATURE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.STRUCTURAL_FEATURE__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.STRUCTURAL_FEATURE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.STRUCTURAL_FEATURE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.STRUCTURAL_FEATURE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.STRUCTURAL_FEATURE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.STRUCTURAL_FEATURE__UUID:
				return getUuid();
			case UML2Package.STRUCTURAL_FEATURE__TEMPLATE_BINDING:
			...
			case UML2Package.STRUCTURAL_FEATURE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.STRUCTURAL_FEATURE__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.STRUCTURAL_FEATURE__READ_WRITE:
				return getReadWrite();
		}
	...
	public String toString() {
		...
		result.append(", readWrite: "); //$NON-NLS-1$
