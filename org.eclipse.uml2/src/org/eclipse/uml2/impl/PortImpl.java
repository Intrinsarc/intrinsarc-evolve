 ...
 *
 * $Id: PortImpl.java,v 1.1 2009-03-04 23:06:40 andrew Exp $
 */
 ...
 *   <li>{@link org.eclipse.uml2.impl.PortImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortImpl extends PropertyImpl implements Port {
	 ...
	 * @ordered
	 */
	protected static final int IS_BEHAVIOR_EFLAG = 1 << 14;
	 ...
	 * @ordered
	 */
	protected static final int IS_SERVICE_EFLAG = 1 << 15;
	 ...
	 * @ordered
	 */
	protected static final PortKind KIND_EDEFAULT = PortKind.NORMAL_LITERAL;
	...
	protected PortImpl() {
		...
		if (PortImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public EList getRedefinedPorts() {
		if (redefinedPort == null) {
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET) {
			 		...
			 		redefinedPort = new com.intrinsarc.emflist.PersistentEList(Port.class, this, UML2Package.PORT__REDEFINED_PORT);
			 		return redefinedPort;
			 }
			return new com.intrinsarc.emflist.UnmodifiableEList(Port.class, this, UML2Package.PORT__REDEFINED_PORT);
		}      
		return redefinedPort;
	}
  ...
  public ProtocolStateMachine undeleted_getProtocol() {
	...
	public void setKind(PortKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.PORT__KIND, oldKind, kind));
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.PORT__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.PORT__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.PORT__OWNED_ANONYMOUS_TYPE:
					return basicSetOwnedAnonymousType(null, msgs);
				case UML2Package.PORT__DEFAULT_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.PORT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.PORT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.PORT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.PORT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.PORT__UUID:
				return getUuid();
			case UML2Package.PORT__TEMPLATE_BINDING:
			...
			case UML2Package.PORT__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.PORT__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.PORT__READ_WRITE:
				return getReadWrite();
			case UML2Package.PORT__TEMPLATE_PARAMETER:
