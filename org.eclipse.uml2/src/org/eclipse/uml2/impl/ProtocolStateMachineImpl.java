 ...
 *
 * $Id: ProtocolStateMachineImpl.java,v 1.1 2009-03-04 23:06:43 andrew Exp $
 */
...
public class ProtocolStateMachineImpl extends StateMachineImpl implements ProtocolStateMachine {
	 ...
	 * @ordered
	 */
	protected EList conformance = null;
	...
	protected ProtocolStateMachineImpl() {
		...
		if (ProtocolStateMachineImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public java.util.ArrayList undeleted_getConformances() {
		java.util.ArrayList temp = new java.util.ArrayList();

		if (conformance != null) {
			for (Object object : conformance) {
	...
	public ProtocolConformance createConformance() {
		...
		settable_getConformances().add(newConformance);
		return newConformance;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.PROTOCOL_STATE_MACHINE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_DELETED_ATTRIBUTES:
					return ((InternalEList)getDeltaDeletedAttributes()).basicRemove(otherEnd, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_REPLACED_ATTRIBUTES:
					return ((InternalEList)getDeltaReplacedAttributes()).basicRemove(otherEnd, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_DELETED_PORTS:
					return ((InternalEList)getDeltaDeletedPorts()).basicRemove(otherEnd, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_REPLACED_PORTS:
					return ((InternalEList)getDeltaReplacedPorts()).basicRemove(otherEnd, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_DELETED_CONNECTORS:
					return ((InternalEList)getDeltaDeletedConnectors()).basicRemove(otherEnd, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_REPLACED_CONNECTORS:
					return ((InternalEList)getDeltaReplacedConnectors()).basicRemove(otherEnd, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__DELTA_DELETED_OPERATIONS:
				...
				case UML2Package.PROTOCOL_STATE_MACHINE__CONTEXT:
					return eBasicSetContainer(null, UML2Package.PROTOCOL_STATE_MACHINE__CONTEXT, msgs);
				case UML2Package.PROTOCOL_STATE_MACHINE__SPECIFICATION:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.PROTOCOL_STATE_MACHINE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.PROTOCOL_STATE_MACHINE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.PROTOCOL_STATE_MACHINE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.PROTOCOL_STATE_MACHINE__UUID:
				return getUuid();
			case UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_BINDING:
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.PROTOCOL_STATE_MACHINE__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__COMPONENT_KIND:
