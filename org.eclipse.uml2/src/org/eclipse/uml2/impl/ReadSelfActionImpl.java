 ...
 *
 * $Id: ReadSelfActionImpl.java,v 1.1 2009-03-04 23:06:37 andrew Exp $
 */
...
public class ReadSelfActionImpl extends ActionImpl implements ReadSelfAction {
	...
	protected ReadSelfActionImpl() {
		...
		if (ReadSelfActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public OutputPin undeleted_getResult() {
	...
	public void setResult(OutputPin newResult) {
		if (newResult != result) {
			...
			if (newResult != null)
				msgs = ((InternalEObject)newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2Package.READ_SELF_ACTION__RESULT, null, msgs);
			msgs = basicSetResult(newResult, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.READ_SELF_ACTION__RESULT, newResult, newResult));
	...
	public OutputPin createResult(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, 0, UML2Package.READ_SELF_ACTION__RESULT, null, newResult));
		}
		setResult(newResult);
		return newResult;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.READ_SELF_ACTION__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.READ_SELF_ACTION__OWNED_TEMPLATE_SIGNATURE, null, msgs);
					return basicSetOwnedTemplateSignature((TemplateSignature)otherEnd, msgs);
				case UML2Package.READ_SELF_ACTION__CLIENT_DEPENDENCY:
					return ((InternalEList)getClientDependencies()).basicAdd(otherEnd, msgs);
				case UML2Package.READ_SELF_ACTION__OUTGOING:
				...
				case UML2Package.READ_SELF_ACTION__ACTIVITY:
					...
					return eBasicSetContainer(otherEnd, UML2Package.READ_SELF_ACTION__ACTIVITY, msgs);
				case UML2Package.READ_SELF_ACTION__IN_STRUCTURED_NODE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UML2Package.READ_SELF_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.READ_SELF_ACTION__IN_PARTITION:
					return ((InternalEList)getInPartitions()).basicAdd(otherEnd, msgs);
				case UML2Package.READ_SELF_ACTION__IN_INTERRUPTIBLE_REGION:
					return ((InternalEList)getInInterruptibleRegions()).basicAdd(otherEnd, msgs);
				case UML2Package.READ_SELF_ACTION__HANDLER:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.READ_SELF_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.READ_SELF_ACTION__NAME_EXPRESSION:
					return basicSetNameExpression(null, msgs);
				case UML2Package.READ_SELF_ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.READ_SELF_ACTION__ACTIVITY:
					return eBasicSetContainer(null, UML2Package.READ_SELF_ACTION__ACTIVITY, msgs);
				case UML2Package.READ_SELF_ACTION__IN_STRUCTURED_NODE:
					return eBasicSetContainer(null, UML2Package.READ_SELF_ACTION__IN_STRUCTURED_NODE, msgs);
				case UML2Package.READ_SELF_ACTION__IN_PARTITION:
				...
				case UML2Package.READ_SELF_ACTION__LOCAL_PRECONDITION:
					return ((InternalEList)getLocalPreconditions()).basicRemove(otherEnd, msgs);
				case UML2Package.READ_SELF_ACTION__LOCAL_POSTCONDITION:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.READ_SELF_ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.READ_SELF_ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.READ_SELF_ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.READ_SELF_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.READ_SELF_ACTION__UUID:
				return getUuid();
			case UML2Package.READ_SELF_ACTION__TEMPLATE_BINDING:
			...
			case UML2Package.READ_SELF_ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.READ_SELF_ACTION__REVERSE_GENERALIZATIONS:
				return getReverseGeneralizations();
			case UML2Package.READ_SELF_ACTION__REDEFINITION_CONTEXT:
				return getRedefinitionContexts();
			case UML2Package.READ_SELF_ACTION__IS_LEAF:
