 ...
 *
 * $Id: WriteStructuralFeatureActionImpl.java,v 1.1 2009-03-04 23:06:40 andrew Exp $
 */
...
public abstract class WriteStructuralFeatureActionImpl extends StructuralFeatureActionImpl implements WriteStructuralFeatureAction {
	...
	protected WriteStructuralFeatureActionImpl() {
		...
		if (WriteStructuralFeatureActionImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public InputPin undeleted_getValue() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__UUID:
				return getUuid();
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__TEMPLATE_BINDING:
			...
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.WRITE_STRUCTURAL_FEATURE_ACTION__REVERSE_GENERALIZATIONS:
	...
	protected EList getInputsHelper(EList input) {
		...
		if (eIsSet(UML2Package.eINSTANCE.getWriteStructuralFeatureAction_Value())) {
			input.add(getValue());
		}
		return input;
	}
