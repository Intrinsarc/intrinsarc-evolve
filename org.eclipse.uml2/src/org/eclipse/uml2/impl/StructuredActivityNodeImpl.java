 ...
 *
 * $Id: StructuredActivityNodeImpl.java,v 1.1 2009-03-04 23:06:39 andrew Exp $
 */
...
public class StructuredActivityNodeImpl extends ActionImpl implements StructuredActivityNode {
	...
	protected StructuredActivityNodeImpl() {
		...
		if (StructuredActivityNodeImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getOwnedRules() {
	...
	public Constraint createOwnedRule(EClass eClass) {
		...
		settable_getOwnedRules().add(newOwnedRule);
		return newOwnedRule;
	}
  ...
  public java.util.ArrayList undeleted_getElementImports() {
	...
	public ElementImport createElementImport() {
		...
		settable_getElementImports().add(newElementImport);
		return newElementImport;
	}
  ...
  public java.util.ArrayList undeleted_getPackageImports() {
	...
	public PackageImport createPackageImport(EClass eClass) {
		...
		settable_getPackageImports().add(newPackageImport);
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public java.util.ArrayList undeleted_getVariables() {
		java.util.ArrayList temp = new java.util.ArrayList();
	...
	public Variable createVariable() {
		...
		settable_getVariables().add(newVariable);
		return newVariable;
	}
  ...
  public java.util.ArrayList undeleted_getContainedNodes() {
    ...
    public ActivityNode createContainedNode(EClass eClass) {
		...
		settable_getContainedNodes().add(newContainedNode);
  ...
  public java.util.ArrayList undeleted_getContainedEdges() {
	...
	public ActivityEdge createContainedEdge(EClass eClass) {
		...
		settable_getContainedEdges().add(newContainedEdge);
  ...
  public Activity undeleted_getActivityGroup_activity()
  {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.STRUCTURED_ACTIVITY_NODE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.STRUCTURED_ACTIVITY_NODE__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.STRUCTURED_ACTIVITY_NODE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.STRUCTURED_ACTIVITY_NODE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.STRUCTURED_ACTIVITY_NODE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.STRUCTURED_ACTIVITY_NODE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.STRUCTURED_ACTIVITY_NODE__UUID:
				return getUuid();
			case UML2Package.STRUCTURED_ACTIVITY_NODE__TEMPLATE_BINDING:
			...
			case UML2Package.STRUCTURED_ACTIVITY_NODE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.STRUCTURED_ACTIVITY_NODE__REVERSE_GENERALIZATIONS:
