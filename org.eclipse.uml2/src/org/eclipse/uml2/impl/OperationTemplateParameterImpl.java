 ...
 *
 * $Id: OperationTemplateParameterImpl.java,v 1.1 2009-03-04 23:06:36 andrew Exp $
 */
...
public class OperationTemplateParameterImpl extends TemplateParameterImpl implements OperationTemplateParameter {
	...
	protected OperationTemplateParameterImpl() {
		...
		if (OperationTemplateParameterImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	protected EClass eStaticClass() {
		return UML2Package.eINSTANCE.getOperationTemplateParameter();
	}
		...
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__SIGNATURE:
					...
					return eBasicSetContainer(otherEnd, UML2Package.OPERATION_TEMPLATE_PARAMETER__SIGNATURE, msgs);
				...
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT:
					if (ownedParameteredElement != null)
						msgs = ((InternalEObject)ownedParameteredElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.OPERATION_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__APPLIED_BASIC_STEREOTYPE_VALUES:
					return ((InternalEList)getAppliedBasicStereotypeValues()).basicRemove(otherEnd, msgs);
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__SIGNATURE:
					return eBasicSetContainer(null, UML2Package.OPERATION_TEMPLATE_PARAMETER__SIGNATURE, msgs);
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT:
					return basicSetParameteredElement(null, msgs);
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT:
					return basicSetOwnedParameteredElement(null, msgs);
				case UML2Package.OPERATION_TEMPLATE_PARAMETER__OWNED_DEFAULT:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__UUID:
				return getUuid();
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__SIGNATURE:
				return getSignature();
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT:
			...
			case UML2Package.OPERATION_TEMPLATE_PARAMETER__DEFAULT:
