 ...
 *
 * $Id: PackageImportImpl.java,v 1.1 2009-03-04 23:06:42 andrew Exp $
 */
...
public class PackageImportImpl extends DirectedRelationshipImpl implements PackageImport {
	...
	protected PackageImportImpl() {
		...
		if (PackageImportImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public Namespace undeleted_getImportingNamespace() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.PACKAGE_IMPORT__APPLIED_BASIC_STEREOTYPE_VALUES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.PACKAGE_IMPORT__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.PACKAGE_IMPORT__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.PACKAGE_IMPORT__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.PACKAGE_IMPORT__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.PACKAGE_IMPORT__UUID:
				return getUuid();
