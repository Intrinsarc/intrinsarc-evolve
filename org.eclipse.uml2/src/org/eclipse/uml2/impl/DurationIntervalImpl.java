 ...
 *
 * $Id: DurationIntervalImpl.java,v 1.1 2009-03-04 23:06:36 andrew Exp $
 */
...
public class DurationIntervalImpl extends IntervalImpl implements DurationInterval {
	...
	protected DurationIntervalImpl() {
		...
		if (DurationIntervalImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public EList getMins() {
		if (min == null) {
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET) {
			 		...
			 		min = new com.intrinsarc.emflist.PersistentEList(Duration.class, this, UML2Package.DURATION_INTERVAL__MIN);
			 		return min;
			 }
			return new com.intrinsarc.emflist.UnmodifiableEList(Duration.class, this, UML2Package.DURATION_INTERVAL__MIN);
		}      
		return min;
	}
  ...
  public java.util.ArrayList undeleted_getMins() {
	...
	public EList getMaxes() {
		if (max == null) {
			 if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET) {
			 		// create the list lazily...
			 		max = new com.intrinsarc.emflist.PersistentEList(Duration.class, this, UML2Package.DURATION_INTERVAL__MAX);
			 		return max;
			 }
			return new com.intrinsarc.emflist.UnmodifiableEList(Duration.class, this, UML2Package.DURATION_INTERVAL__MAX);
		}      
		return max;
	}
  ...
  public java.util.ArrayList undeleted_getMaxes() {
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.DURATION_INTERVAL__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.DURATION_INTERVAL__OWNED_TEMPLATE_SIGNATURE, null, msgs);
				...
				case UML2Package.DURATION_INTERVAL__OWNING_PARAMETER:
					...
					return eBasicSetContainer(otherEnd, UML2Package.DURATION_INTERVAL__OWNING_PARAMETER, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.DURATION_INTERVAL__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.DURATION_INTERVAL__OWNED_ANONYMOUS_DEPENDENCIES:
					return ((InternalEList)getOwnedAnonymousDependencies()).basicRemove(otherEnd, msgs);
				case UML2Package.DURATION_INTERVAL__TEMPLATE_PARAMETER:
					return basicSetTemplateParameter(null, msgs);
				case UML2Package.DURATION_INTERVAL__OWNING_PARAMETER:
					return eBasicSetContainer(null, UML2Package.DURATION_INTERVAL__OWNING_PARAMETER, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.DURATION_INTERVAL__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.DURATION_INTERVAL__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.DURATION_INTERVAL__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.DURATION_INTERVAL__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.DURATION_INTERVAL__UUID:
				return getUuid();
			case UML2Package.DURATION_INTERVAL__TEMPLATE_BINDING:
			...
			case UML2Package.DURATION_INTERVAL__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.DURATION_INTERVAL__REVERSE_GENERALIZATIONS:
