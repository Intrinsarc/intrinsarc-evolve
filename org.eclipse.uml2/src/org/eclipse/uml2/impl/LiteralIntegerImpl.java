 ...
 *
 * $Id: LiteralIntegerImpl.java,v 1.1 2009-03-04 23:06:40 andrew Exp $
 */
...
public class LiteralIntegerImpl extends LiteralSpecificationImpl implements LiteralInteger {
	...
	protected LiteralIntegerImpl() {
		...
		if (LiteralIntegerImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.LITERAL_INTEGER__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.LITERAL_INTEGER__OWNED_TEMPLATE_SIGNATURE, null, msgs);
				...
				case UML2Package.LITERAL_INTEGER__OWNING_PARAMETER:
					...
					return eBasicSetContainer(otherEnd, UML2Package.LITERAL_INTEGER__OWNING_PARAMETER, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.LITERAL_INTEGER__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.LITERAL_INTEGER__OWNED_ANONYMOUS_DEPENDENCIES:
					return ((InternalEList)getOwnedAnonymousDependencies()).basicRemove(otherEnd, msgs);
				case UML2Package.LITERAL_INTEGER__TEMPLATE_PARAMETER:
					return basicSetTemplateParameter(null, msgs);
				case UML2Package.LITERAL_INTEGER__OWNING_PARAMETER:
					return eBasicSetContainer(null, UML2Package.LITERAL_INTEGER__OWNING_PARAMETER, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.LITERAL_INTEGER__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.LITERAL_INTEGER__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.LITERAL_INTEGER__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.LITERAL_INTEGER__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.LITERAL_INTEGER__UUID:
				return getUuid();
			case UML2Package.LITERAL_INTEGER__TEMPLATE_BINDING:
			...
			case UML2Package.LITERAL_INTEGER__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.LITERAL_INTEGER__REVERSE_GENERALIZATIONS:
