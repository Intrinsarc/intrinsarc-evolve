 ...
 *
 * $Id: DeviceImpl.java,v 1.1 2009-03-04 23:06:34 andrew Exp $
 */
...
public class DeviceImpl extends NodeImpl implements Device {
	...
	protected DeviceImpl() {
		...
		if (DeviceImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.DEVICE__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.DEVICE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
					return basicSetOwnedTemplateSignature((TemplateSignature)otherEnd, msgs);
				case UML2Package.DEVICE__CLIENT_DEPENDENCY:
					return ((InternalEList)getClientDependencies()).basicAdd(otherEnd, msgs);
				case UML2Package.DEVICE__OWNED_RULE:
					return ((InternalEList)getOwnedRules()).basicAdd(otherEnd, msgs);
				case UML2Package.DEVICE__ELEMENT_IMPORT:
					return ((InternalEList)getElementImports()).basicAdd(otherEnd, msgs);
				case UML2Package.DEVICE__PACKAGE_IMPORT:
					return ((InternalEList)getPackageImports()).basicAdd(otherEnd, msgs);
				case UML2Package.DEVICE__TEMPLATE_PARAMETER:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.DEVICE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.DEVICE__OWNED_ANONYMOUS_DEPENDENCIES:
				...
				case UML2Package.DEVICE__NESTED_NODE:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.DEVICE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.DEVICE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.DEVICE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.DEVICE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.DEVICE__UUID:
				return getUuid();
			case UML2Package.DEVICE__TEMPLATE_BINDING:
				return getTemplateBindings();
			case UML2Package.DEVICE__OWNED_TEMPLATE_SIGNATURE:
				return getOwnedTemplateSignature();
			case UML2Package.DEVICE__NAME:
				return getName();
			...
			case UML2Package.DEVICE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.DEVICE__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.DEVICE__COMPONENT_KIND:
				return getComponentKind();
			case UML2Package.DEVICE__DEPLOYMENT:
				return getDeployments();
			case UML2Package.DEVICE__DEPLOYED_ELEMENT:
