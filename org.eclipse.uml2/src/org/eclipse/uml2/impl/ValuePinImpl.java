 ...
 *
 * $Id: ValuePinImpl.java,v 1.1 2009-03-04 23:06:42 andrew Exp $
 */
  ...
  public ValueSpecification undeleted_getValue() {
			...
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.VALUE_PIN__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.VALUE_PIN__OWNED_TEMPLATE_SIGNATURE, null, msgs);
				...
				case UML2Package.VALUE_PIN__ACTIVITY:
					...
					return eBasicSetContainer(otherEnd, UML2Package.VALUE_PIN__ACTIVITY, msgs);
				case UML2Package.VALUE_PIN__IN_STRUCTURED_NODE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UML2Package.VALUE_PIN__IN_STRUCTURED_NODE, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.VALUE_PIN__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.VALUE_PIN__OWNED_ANONYMOUS_DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.VALUE_PIN__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.VALUE_PIN__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.VALUE_PIN__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.VALUE_PIN__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.VALUE_PIN__UUID:
				return getUuid();
			case UML2Package.VALUE_PIN__TEMPLATE_BINDING:
			...
			case UML2Package.VALUE_PIN__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.VALUE_PIN__REVERSE_GENERALIZATIONS:
