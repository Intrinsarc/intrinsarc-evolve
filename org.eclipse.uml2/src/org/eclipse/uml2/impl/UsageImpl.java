 ...
 *
 * $Id: UsageImpl.java,v 1.1 2009-03-04 23:06:40 andrew Exp $
 */
...
public class UsageImpl extends DependencyImpl implements Usage {
	...
	protected UsageImpl() {
		...
		if (UsageImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.USAGE__TEMPLATE_BINDING:
					return ((InternalEList)getTemplateBindings()).basicAdd(otherEnd, msgs);
				case UML2Package.USAGE__OWNED_TEMPLATE_SIGNATURE:
					if (ownedTemplateSignature != null)
						msgs = ((InternalEObject)ownedTemplateSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2Package.USAGE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
					return basicSetOwnedTemplateSignature((TemplateSignature)otherEnd, msgs);
				case UML2Package.USAGE__CLIENT_DEPENDENCY:
					return ((InternalEList)getClientDependencies()).basicAdd(otherEnd, msgs);
				case UML2Package.USAGE__TEMPLATE_PARAMETER:
				...
				case UML2Package.USAGE__OWNING_PARAMETER:
					...
					return eBasicSetContainer(otherEnd, UML2Package.USAGE__OWNING_PARAMETER, msgs);
				case UML2Package.USAGE__CLIENT:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.USAGE__OWNED_COMMENT:
					return ((InternalEList)getOwnedComments()).basicRemove(otherEnd, msgs);
				case UML2Package.USAGE__APPLIED_BASIC_STEREOTYPE_VALUES:
				...
				case UML2Package.USAGE__OWNED_ANONYMOUS_DEPENDENCIES:
					return ((InternalEList)getOwnedAnonymousDependencies()).basicRemove(otherEnd, msgs);
				case UML2Package.USAGE__TEMPLATE_PARAMETER:
					return basicSetTemplateParameter(null, msgs);
				case UML2Package.USAGE__OWNING_PARAMETER:
					return eBasicSetContainer(null, UML2Package.USAGE__OWNING_PARAMETER, msgs);
				case UML2Package.USAGE__CLIENT:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.USAGE__OWNED_ELEMENT:
				return getOwnedElements();
			case UML2Package.USAGE__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case UML2Package.USAGE__OWNED_COMMENT:
				return getOwnedComments();
			case UML2Package.USAGE__JDELETED:
				return new Integer(getJ_deleted());
			case UML2Package.USAGE__DOCUMENTATION:
				return getDocumentation();
			case UML2Package.USAGE__APPLIED_BASIC_STEREOTYPES:
				return getAppliedBasicStereotypes();
			case UML2Package.USAGE__APPLIED_BASIC_STEREOTYPE_VALUES:
				return getAppliedBasicStereotypeValues();
			case UML2Package.USAGE__UUID:
				return getUuid();
			case UML2Package.USAGE__TEMPLATE_BINDING:
				return getTemplateBindings();
			case UML2Package.USAGE__OWNED_TEMPLATE_SIGNATURE:
				return getOwnedTemplateSignature();
			case UML2Package.USAGE__NAME:
				return getName();
			...
			case UML2Package.USAGE__REVERSE_DEPENDENCIES:
				return getReverseDependencies();
			case UML2Package.USAGE__REVERSE_GENERALIZATIONS:
			...
			case UML2Package.USAGE__SOURCE:
				return getSources();
			case UML2Package.USAGE__TARGET:
				return getTargets();
			case UML2Package.USAGE__CLIENT:
				return getClients();
			case UML2Package.USAGE__SUPPLIER:
				return getSuppliers();
			case UML2Package.USAGE__DEPENDENCY_TARGET:
				if (resolve) return getDependencyTarget();
				return basicGetDependencyTarget();
			case UML2Package.USAGE__RESEMBLANCE:
