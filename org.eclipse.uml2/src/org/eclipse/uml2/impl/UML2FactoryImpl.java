 ...
 *
 * $Id: UML2FactoryImpl.java,v 1.2 2009-04-22 10:01:12 andrew Exp $
 */
...
public class UML2FactoryImpl extends EFactoryImpl implements UML2Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case UML2Package.JFIGURE_CONTAINER: return createJ_FigureContainer();
			case UML2Package.JFIGURE: return createJ_Figure();
			case UML2Package.JPROPERTY: return createJ_Property();
			case UML2Package.JDIAGRAM: return createJ_Diagram();
			case UML2Package.JDIAGRAM_HOLDER: return createJ_DiagramHolder();
			case UML2Package.APPLIED_BASIC_STEREOTYPE_VALUE: return createAppliedBasicStereotypeValue();
			case UML2Package.PROPERTY_VALUE_SPECIFICATION: return createPropertyValueSpecification();
			case UML2Package.DELTA_REPLACED_CONSTITUENT: return createDeltaReplacedConstituent();
			case UML2Package.DELTA_DELETED_CONSTITUENT: return createDeltaDeletedConstituent();
			case UML2Package.DELTA_REPLACED_ATTRIBUTE: return createDeltaReplacedAttribute();
			case UML2Package.DELTA_DELETED_ATTRIBUTE: return createDeltaDeletedAttribute();
			case UML2Package.DELTA_REPLACED_PORT: return createDeltaReplacedPort();
			case UML2Package.DELTA_DELETED_PORT: return createDeltaDeletedPort();
			case UML2Package.DELTA_REPLACED_CONNECTOR: return createDeltaReplacedConnector();
			case UML2Package.DELTA_DELETED_CONNECTOR: return createDeltaDeletedConnector();
			case UML2Package.DELTA_REPLACED_OPERATION: return createDeltaReplacedOperation();
