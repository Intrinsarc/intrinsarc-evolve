...
public abstract class BehavioredClassifierImpl extends ClassifierImpl implements BehavioredClassifier {
	...
	protected BehavioredClassifierImpl() {
		...
		if (BehavioredClassifierImpl.class.equals(getClass()) && org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
  ...
  public java.util.ArrayList undeleted_getOwnedTriggers() {
	...
	public EList getOwnedStateMachines() {
      ...
      if (org.eclipse.emf.common.util.EMFOptions.CREATE_LISTS_LAZILY_FOR_GET)
      {
          ...
          ownedStateMachine = new PersistentEList(StateMachine.class, this, UML2Package.BEHAVIORED_CLASSIFIER__OWNED_STATE_MACHINE, UML2Package.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT);
      }
		}
