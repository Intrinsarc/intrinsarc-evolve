 ...
 *
 * $Id: UML2Validator.java,v 1.1 2009-03-04 23:06:49 andrew Exp $
 */
...
public class UML2Validator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map context) {
		switch (classifierID) {
			...
			case UML2Package.JFIGURE_CONTAINER:
				return validateJ_FigureContainer((J_FigureContainer)value, diagnostics, context);
			case UML2Package.JFIGURE:
				return validateJ_Figure((J_Figure)value, diagnostics, context);
			case UML2Package.JPROPERTY:
				return validateJ_Property((J_Property)value, diagnostics, context);
			case UML2Package.JDIAGRAM:
				return validateJ_Diagram((J_Diagram)value, diagnostics, context);
			case UML2Package.JDIAGRAM_HOLDER:
				return validateJ_DiagramHolder((J_DiagramHolder)value, diagnostics, context);
			case UML2Package.APPLIED_BASIC_STEREOTYPE_VALUE:
				return validateAppliedBasicStereotypeValue((AppliedBasicStereotypeValue)value, diagnostics, context);
			case UML2Package.PROPERTY_VALUE_SPECIFICATION:
				return validatePropertyValueSpecification((PropertyValueSpecification)value, diagnostics, context);
			case UML2Package.DELTA_REPLACED_CONSTITUENT:
				return validateDeltaReplacedConstituent((DeltaReplacedConstituent)value, diagnostics, context);
			case UML2Package.DELTA_DELETED_CONSTITUENT:
				return validateDeltaDeletedConstituent((DeltaDeletedConstituent)value, diagnostics, context);
			case UML2Package.DELTA_REPLACED_ATTRIBUTE:
				return validateDeltaReplacedAttribute((DeltaReplacedAttribute)value, diagnostics, context);
			case UML2Package.DELTA_DELETED_ATTRIBUTE:
				return validateDeltaDeletedAttribute((DeltaDeletedAttribute)value, diagnostics, context);
			case UML2Package.DELTA_REPLACED_PORT:
				return validateDeltaReplacedPort((DeltaReplacedPort)value, diagnostics, context);
			case UML2Package.DELTA_DELETED_PORT:
				return validateDeltaDeletedPort((DeltaDeletedPort)value, diagnostics, context);
			case UML2Package.DELTA_REPLACED_CONNECTOR:
				return validateDeltaReplacedConnector((DeltaReplacedConnector)value, diagnostics, context);
			case UML2Package.DELTA_DELETED_CONNECTOR:
				return validateDeltaDeletedConnector((DeltaDeletedConnector)value, diagnostics, context);
			case UML2Package.DELTA_REPLACED_OPERATION:
				return validateDeltaReplacedOperation((DeltaReplacedOperation)value, diagnostics, context);
			case UML2Package.DELTA_DELETED_OPERATION:
				return validateDeltaDeletedOperation((DeltaDeletedOperation)value, diagnostics, context);
			case UML2Package.PORT_REMAP:
				return validatePortRemap((PortRemap)value, diagnostics, context);
	...
	public boolean validateInformationFlow(InformationFlow informationFlow, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateNamedElement_validateNoName(informationFlow, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateQualifiedName(informationFlow, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateVisibilityNeedsOwnership(informationFlow, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputPin(OutputPin outputPin, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGt0(outputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerGe0(outputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGeLower(outputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerEqLowerbound(outputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperEqUpperbound(outputPin, diagnostics, context);
		return result;
	}
	...
	public boolean validateInputPin(InputPin inputPin, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGt0(inputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerGe0(inputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGeLower(inputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerEqLowerbound(inputPin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperEqUpperbound(inputPin, diagnostics, context);
		return result;
	}
	...
	public boolean validatePin(Pin pin, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGt0(pin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerGe0(pin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGeLower(pin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerEqLowerbound(pin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperEqUpperbound(pin, diagnostics, context);
		return result;
	}
	...
	public boolean validateValuePin(ValuePin valuePin, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGt0(valuePin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerGe0(valuePin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGeLower(valuePin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerEqLowerbound(valuePin, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperEqUpperbound(valuePin, diagnostics, context);
		return result;
	}
	...
	public boolean validateVariable(Variable variable, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGt0(variable, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerGe0(variable, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperGeLower(variable, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateLowerEqLowerbound(variable, diagnostics, context);
		if (result || diagnostics != null) result &= validateMultiplicityElement_validateUpperEqUpperbound(variable, diagnostics, context);
		return result;
	}
	...
	public boolean validatePrimitiveFunction(PrimitiveFunction primitiveFunction, DiagnosticChain diagnostics, Map context) {
		...
		if (result || diagnostics != null) result &= validateNamedElement_validateNoName(primitiveFunction, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateQualifiedName(primitiveFunction, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateVisibilityNeedsOwnership(primitiveFunction, diagnostics, context);
		return result;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public boolean validateJ_FigureContainer(J_FigureContainer j_FigureContainer, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(j_FigureContainer, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(j_FigureContainer, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(j_FigureContainer, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(j_FigureContainer, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(j_FigureContainer, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(j_FigureContainer, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateJ_Figure(J_Figure j_Figure, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(j_Figure, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(j_Figure, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(j_Figure, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(j_Figure, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(j_Figure, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(j_Figure, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateJ_Property(J_Property j_Property, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(j_Property, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(j_Property, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(j_Property, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(j_Property, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(j_Property, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(j_Property, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateJ_Diagram(J_Diagram j_Diagram, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(j_Diagram, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(j_Diagram, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(j_Diagram, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(j_Diagram, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(j_Diagram, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(j_Diagram, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateJ_DiagramHolder(J_DiagramHolder j_DiagramHolder, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(j_DiagramHolder, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(j_DiagramHolder, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(j_DiagramHolder, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(j_DiagramHolder, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(j_DiagramHolder, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(j_DiagramHolder, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateAppliedBasicStereotypeValue(AppliedBasicStereotypeValue appliedBasicStereotypeValue, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(appliedBasicStereotypeValue, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(appliedBasicStereotypeValue, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(appliedBasicStereotypeValue, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(appliedBasicStereotypeValue, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(appliedBasicStereotypeValue, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(appliedBasicStereotypeValue, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validatePropertyValueSpecification(PropertyValueSpecification propertyValueSpecification, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateNoName(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateQualifiedName(propertyValueSpecification, diagnostics, context);
		if (result || diagnostics != null) result &= validateNamedElement_validateVisibilityNeedsOwnership(propertyValueSpecification, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaReplacedConstituent(DeltaReplacedConstituent deltaReplacedConstituent, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaReplacedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaReplacedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaReplacedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaReplacedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaReplacedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaReplacedConstituent, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaDeletedConstituent(DeltaDeletedConstituent deltaDeletedConstituent, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaDeletedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaDeletedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaDeletedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaDeletedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaDeletedConstituent, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaDeletedConstituent, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaReplacedAttribute(DeltaReplacedAttribute deltaReplacedAttribute, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaReplacedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaReplacedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaReplacedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaReplacedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaReplacedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaReplacedAttribute, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaDeletedAttribute(DeltaDeletedAttribute deltaDeletedAttribute, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaDeletedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaDeletedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaDeletedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaDeletedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaDeletedAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaDeletedAttribute, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaReplacedPort(DeltaReplacedPort deltaReplacedPort, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaReplacedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaReplacedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaReplacedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaReplacedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaReplacedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaReplacedPort, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaDeletedPort(DeltaDeletedPort deltaDeletedPort, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaDeletedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaDeletedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaDeletedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaDeletedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaDeletedPort, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaDeletedPort, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaReplacedConnector(DeltaReplacedConnector deltaReplacedConnector, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaReplacedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaReplacedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaReplacedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaReplacedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaReplacedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaReplacedConnector, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaDeletedConnector(DeltaDeletedConnector deltaDeletedConnector, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaDeletedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaDeletedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaDeletedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaDeletedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaDeletedConnector, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaDeletedConnector, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaReplacedOperation(DeltaReplacedOperation deltaReplacedOperation, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaReplacedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaReplacedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaReplacedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaReplacedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaReplacedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaReplacedOperation, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateDeltaDeletedOperation(DeltaDeletedOperation deltaDeletedOperation, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(deltaDeletedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(deltaDeletedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(deltaDeletedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(deltaDeletedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(deltaDeletedOperation, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(deltaDeletedOperation, diagnostics, context);
		return result;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public boolean validatePortRemap(PortRemap portRemap, DiagnosticChain diagnostics, Map context) {
		boolean result = validate_EveryMultiplicityConforms(portRemap, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(portRemap, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(portRemap, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(portRemap, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateNotOwnSelf(portRemap, diagnostics, context);
		if (result || diagnostics != null) result &= validateElement_validateHasOwner(portRemap, diagnostics, context);
		return result;
	}
