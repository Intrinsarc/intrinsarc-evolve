...
public class SwingJazzExample extends AbstractExample
{
	...
	public void initializeExample()
	{
		...
		// A JLabel
		JLabel label = new JLabel("A JLabel", new ImageIcon(loader.getResource("HCIL-logo.gif")), SwingConstants.CENTER);
		...
		JOptionPane options = new JOptionPane("This is a JOptionPane!", JOptionPane.INFORMATION_MESSAGE, JOptionPane.DEFAULT_OPTION);
		...
		Action select = new AbstractAction("There!", new ImageIcon(loader.getResource("select.gif")))
		{
			public void actionPerformed(ActionEvent e)
			{
			}
