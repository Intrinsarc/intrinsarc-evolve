...
public class ColoredScanner implements LTSInput {
	private final Document doc; // current document
	private int d_Pos; // current position in d_text
	private final Segment d_text; // current text contents
	...
	/**
	 * Sets the range of the scanner. This should be called to reinitialize the
	 * scanner to the desired range of coverage.
	 */
