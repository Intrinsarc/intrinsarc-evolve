...
public class GeneralizedBuchiAutomata {
	...
	public GeneralizedBuchiAutomata(String n, FormulaFactory f,
	...
	public void translate() {
		...
		naccept = fac.processUntils(formula, untils = new ArrayList<Until>());
...
class Transition {
	SortedSet<Formula> propositions;
	int pointsTo;
	BitSet accepting;
	boolean safe_acc;
	...
	Transition(SortedSet<Formula> p, int i, BitSet acc, boolean sa) {
		propositions = p;
		pointsTo = i;
