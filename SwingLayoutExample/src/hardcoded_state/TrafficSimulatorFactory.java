...
public class TrafficSimulatorFactory
{
  ...
  private com.hopstepjump.backbone.runtime.implementation.Terminal x18 = new com.hopstepjump.backbone.runtime.implementation.Terminal();
  private com.hopstepjump.backbone.runtime.implementation.Terminal x19 = new com.hopstepjump.backbone.runtime.implementation.Terminal();
  ...
  private com.hopstepjump.backbone.runtime.implementation.StateDispatcher dispatcher = new com.hopstepjump.backbone.runtime.implementation.StateDispatcher();
  public com.hopstepjump.backbone.runtime.api.IRun getRun() { return x6.getRun_IRun(null); }
  ...
  public TrafficSimulatorFactory initialize(java.util.Map<String, Object> values)
  {
    ...
    com.hopstepjump.backbone.runtime.api.ITerminal c5 = x19.getTerminal_ITerminal(com.hopstepjump.backbone.runtime.api.ITerminal.class);
    com.hopstepjump.backbone.runtime.api.ITerminal c6 = x18.getTerminal_ITerminal(com.hopstepjump.backbone.runtime.api.ITerminal.class);
    com.hopstepjump.backbone.runtime.api.ITransition c7 = x19.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
    com.hopstepjump.backbone.runtime.api.ITransition c8 = x23.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
    com.hopstepjump.backbone.runtime.api.ITransition c9 = x20.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
    com.hopstepjump.backbone.runtime.api.ITransition c10 = x22.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
    com.hopstepjump.backbone.runtime.api.ITransition c11 = x21.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
    com.hopstepjump.backbone.runtime.api.ITransition c12 = x20.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
    ...
    com.hopstepjump.backbone.runtime.api.ITransition c21 = x18.getIn_ITransition(com.hopstepjump.backbone.runtime.api.ITransition.class);
