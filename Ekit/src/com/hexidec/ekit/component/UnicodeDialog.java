...
*/
	...
	public void init(int startIndex)
	{
		...
		for(int counter = 0; counter < UNICODEBLOCKSIZE; counter++)
		{
			...
			{
        // altered by AMcV
				FontRenderContext frcLocal = ((java.awt.Graphics2D)(parentEkit.getFrame().getGraphics())).getFontRenderContext();
		...
		EkitCore.setDialogLocation(this, new Dimension(400, 500));
