		...
		if(this.isEnabled())
		{
			...
			else
			{
				...
				else if(htmlTag.toString().equals(HTML.Tag.FONT.toString()))
				{
					...
					{
						Color color = ExtendedColorChooser.showExtendedDialog(parentEkit.getFrame(), Translatrix.getTranslationString("CustomColorDialog"), Color.black);
					    if(color != null)
						{
