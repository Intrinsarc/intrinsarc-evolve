...
<div class="comment_nav">
	<?php previous_comments_link("<span class='comment_prev button'>Older Comments</span>") ?>
	<?php next_comments_link("<span class='comment_next button'>Newer Comments</span>") ?>
</div>
...
<p><input name="submit" class="button" type="submit" id="submit" tabindex="5" value="Submit Comment" /><?php cancel_comment_reply_link("Cancel Reply"); ?><!--to cancel the comment link or not-->
