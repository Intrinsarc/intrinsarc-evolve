...
abstract sig Element
{
	...
	-- is this deleted from a given stratum?
	isDeleted_e: set Stratum,
...
sig Component extends Element
{
	...
	isComposite: Bool,
	cimplementation: lone ComponentImplementation,
...
}
{
	...
	isFalse[isComposite] <=> one cimplementation
...
sig Interface extends Element
{
	...
	myImplementation: lone InterfaceImplementation/Deltas
}
{
	-- for interfaces
