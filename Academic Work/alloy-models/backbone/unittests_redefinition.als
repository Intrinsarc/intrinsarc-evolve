...
// generates a conflict that isn't resolved: replaced parts will be the same.  runs in about 100 secs
run conflict for 3 but exactly 4 Stratum, 5 Element, exactly 4 Component, 4 structure/Ports/Deltas
pred conflict()
{
	no parent
	no links
...
// generates a conflict and resolves it: replaced parts will be the same.  runs in about 
run conflictAndResolution for 3 but
	exactly 5 Stratum,
	exactly 6 Element,
	exactly 5 Component,
	exactly 1 Interface,
	exactly 5 structure/Ports/Deltas,
	exactly 4 structure/Parts/Deltas,
	exactly 4 structure/Connectors/Deltas,
	exactly 0 structure/Operations/Deltas,
	exactly 4 Part,
	5 LinkEnd
...
run conflictAndResolutionX for 3 but
	...
	exactly 6 Component,
	exactly 1 Interface,
	exactly 6 structure/Ports/Deltas,
	exactly 4 structure/Parts/Deltas,
	exactly 4 structure/Connectors/Deltas,
	exactly 0 structure/Operations/Deltas,
	exactly 0 structure/Attributes/Deltas,
	exactly 0 Attribute,
	exactly 0 AttributeID,
	exactly 4 Part,
	6 LinkEnd
...
pred conflictAndResolutionX
{
	some disj s1, s2, s3, s4, s5: Stratum
	{
		...
		Model::errorsOnlyAllowedIn[s2]
		some isInvalid_e
		s3.ownedElements.parts.s3.partType != s4.ownedElements.parts.s4.partType 
	}
}
