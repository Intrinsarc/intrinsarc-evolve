 ...
 *
 * $Id: NamedElementItemProvider.java,v 1.1 2009-03-04 23:08:24 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReverseDependenciesPropertyDescriptor(object);
			addReverseGeneralizationsPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Reverse Dependencies feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReverseDependenciesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_reverseDependencies_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_reverseDependencies_feature", "_UI_NamedElement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2Package.eINSTANCE.getNamedElement_ReverseDependencies(),
				 true,
				 null,
				 null,
				 null));
	...
	/**
	 * This adds a property descriptor for the Reverse Generalizations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReverseGeneralizationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_reverseGeneralizations_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_reverseGeneralizations_feature", "_UI_NamedElement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2Package.eINSTANCE.getNamedElement_ReverseGeneralizations(),
				 true,
				 null,
				 null,
				 null));
