 ...
 *
 * $Id: InputPinItemProvider.java,v 1.1 2009-03-04 23:08:21 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.InputPin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputPinItemProvider
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/InputPin"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_InputPin_type") : //$NON-NLS-1$
			getString("_UI_InputPin_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
