 ...
 *
 * $Id: TimeExpressionItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.TimeExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeExpression_firstTime_feature", "_UI_TimeExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2Package.eINSTANCE.getTimeExpression_FirstTime(),
				 true,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeExpression_event_feature", "_UI_TimeExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2Package.eINSTANCE.getTimeExpression_Event(),
				 true,
				 null,
				 null,
				 null));
	...
	{
		return getResourceLocator().getImage("full/obj16/TimeExpression"); //$NON-NLS-1$
	}
