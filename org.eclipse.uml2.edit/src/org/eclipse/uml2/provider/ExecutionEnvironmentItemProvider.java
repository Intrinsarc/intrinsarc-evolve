 ...
 *
 * $Id: ExecutionEnvironmentItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.ExecutionEnvironment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutionEnvironmentItemProvider
	...
	/**
	 * This returns ExecutionEnvironment.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/ExecutionEnvironment"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ExecutionEnvironment)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExecutionEnvironment_type") : //$NON-NLS-1$
			getString("_UI_ExecutionEnvironment_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
