 ...
 *
 * $Id: ProtocolStateMachineItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
 ...
 * @generated
 */
public class ProtocolStateMachineItemProvider
	extends StateMachineItemProvider
	implements
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_ProtocolStateMachine_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
