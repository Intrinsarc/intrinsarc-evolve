 ...
 *
 * $Id: LiteralBooleanItemProvider.java,v 1.1 2009-03-04 23:08:23 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.LiteralBoolean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralBooleanItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LiteralBoolean_value_feature", "_UI_LiteralBoolean_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2Package.eINSTANCE.getLiteralBoolean_Value(),
				 true,
	...
	{
		return getResourceLocator().getImage("full/obj16/LiteralBoolean"); //$NON-NLS-1$
	}
