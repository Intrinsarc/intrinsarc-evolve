 ...
 *
 * $Id: DurationObservationActionItemProvider.java,v 1.1 2009-03-04 23:08:21 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.DurationObservationAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DurationObservationActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DurationObservationAction_duration_feature", "_UI_DurationObservationAction_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(UML2Package.eINSTANCE.getDurationObservationAction_Duration());
		}
	...
	{
		return getResourceLocator().getImage("full/obj16/DurationObservationAction"); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(DurationObservationAction.class))
		{
