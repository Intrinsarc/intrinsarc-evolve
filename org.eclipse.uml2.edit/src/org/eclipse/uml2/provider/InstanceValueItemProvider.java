 ...
 *
 * $Id: InstanceValueItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.InstanceValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InstanceValue_instance_feature", "_UI_InstanceValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2Package.eINSTANCE.getInstanceValue_Instance(),
				 true,
				 null,
				 null,
				 null));
	...
	public Collection getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(UML2Package.eINSTANCE.getInstanceValue_OwnedAnonymousInstanceValue());
		}
	...
	{
		return getResourceLocator().getImage("full/obj16/InstanceValue"); //$NON-NLS-1$
	}
	...
	{
		String label = ((InstanceValue)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InstanceValue_type") : //$NON-NLS-1$
			getString("_UI_InstanceValue_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
