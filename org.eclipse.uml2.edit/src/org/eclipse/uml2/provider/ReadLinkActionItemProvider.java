 ...
 *
 * $Id: ReadLinkActionItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.ReadLinkAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReadLinkActionItemProvider
	extends LinkActionItemProvider
	implements
	 ...
	 * @generated
	 */
	public ReadLinkActionItemProvider(AdapterFactory adapterFactory)
	{
	...
	/**
	 * This returns ReadLinkAction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return getResourceLocator().getImage("full/obj16/ReadLinkAction"); //$NON-NLS-1$
	}
	...
	{
		String label = ((ReadLinkAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ReadLinkAction_type") : //$NON-NLS-1$
			getString("_UI_ReadLinkAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
