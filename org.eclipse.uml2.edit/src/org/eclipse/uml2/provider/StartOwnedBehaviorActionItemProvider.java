 ...
 *
 * $Id: StartOwnedBehaviorActionItemProvider.java,v 1.1 2009-03-04 23:08:21 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.StartOwnedBehaviorAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartOwnedBehaviorActionItemProvider
	 ...
	 * @generated
	 */
	public StartOwnedBehaviorActionItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/StartOwnedBehaviorAction"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((StartOwnedBehaviorAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StartOwnedBehaviorAction_type") : //$NON-NLS-1$
			getString("_UI_StartOwnedBehaviorAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StartOwnedBehaviorAction.class)) {
