 ...
 *
 * $Id: AddStructuralFeatureValueActionItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.AddStructuralFeatureValueAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddStructuralFeatureValueActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AddStructuralFeatureValueAction_insertAt_feature", "_UI_AddStructuralFeatureValueAction_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	/**
	 * This returns AddStructuralFeatureValueAction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_AddStructuralFeatureValueAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
