 ...
 *
 * $Id: ActorItemProvider.java,v 1.1 2009-03-04 23:08:23 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider
	...
	{
		return getResourceLocator().getImage("full/obj16/Actor"); //$NON-NLS-1$
	}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_Actor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
