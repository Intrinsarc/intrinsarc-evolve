 ...
 *
 * $Id: OutputPinItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
 ...
 * @generated
 */
public class OutputPinItemProvider
	...
	{
		return getResourceLocator().getImage("full/obj16/OutputPin"); //$NON-NLS-1$
	}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_OutputPin_type") : //$NON-NLS-1$
			getString("_UI_OutputPin_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
