 ...
 *
 * $Id: InterfaceItemProvider.java,v 1.1 2009-03-04 23:08:22 andrew Exp $
 */
...
public class InterfaceItemProvider
	...
	public Collection getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_NestedClassifier());
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_OwnedReception());
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_Protocol());
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_DeltaDeletedOperations());
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_DeltaReplacedOperations());
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_DeltaDeletedAttributes());
			childrenFeatures.add(UML2Package.eINSTANCE.getInterface_DeltaReplacedAttributes());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(UML2Package.eINSTANCE.getInterface_DeltaDeletedOperations(),
		...
		newChildDescriptors.add
			(createChildParameter
				(UML2Package.eINSTANCE.getInterface_DeltaReplacedOperations(),
		...
		newChildDescriptors.add
			(createChildParameter
				(UML2Package.eINSTANCE.getInterface_DeltaDeletedAttributes(),
		...
		newChildDescriptors.add
			(createChildParameter
				(UML2Package.eINSTANCE.getInterface_DeltaReplacedAttributes(),
