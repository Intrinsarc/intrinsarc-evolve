 ...
 *
 * $Id: CallOperationActionItemProvider.java,v 1.1 2009-03-04 23:08:21 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.CallOperationAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallOperationActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_CallOperationAction_target_feature", "_UI_CallOperationAction_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(UML2Package.eINSTANCE.getCallOperationAction_Target());
		}
	...
	{
		return getResourceLocator().getImage("full/obj16/CallOperationAction"); //$NON-NLS-1$
	}
	...
	{
		String label = ((CallOperationAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CallOperationAction_type") : //$NON-NLS-1$
			getString("_UI_CallOperationAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection)
	{
		...
		boolean qualify =
			...
			childFeature == UML2Package.eINSTANCE.getCallOperationAction_Target();
