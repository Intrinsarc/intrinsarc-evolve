 ...
 *
 * $Id: EnumerationItemProvider.java,v 1.1 2009-03-04 23:08:23 andrew Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider
	...
	public List getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addOwnedLiteralPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_ownedLiteral_feature", "_UI_Enumeration_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(UML2Package.eINSTANCE.getEnumeration_OwnedLiteral());
		}
	...
	{
		return getResourceLocator().getImage("full/obj16/Enumeration"); //$NON-NLS-1$
	}
