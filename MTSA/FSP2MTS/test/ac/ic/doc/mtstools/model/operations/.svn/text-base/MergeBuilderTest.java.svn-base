...
public class MergeBuilderTest extends MTSTestBase {
	...
	private void doMergeTest(String fsmA, String fsmB, String fsmMergeLowerBound) throws Exception {		
		MTS<Long, String> mtsA = testUtils.buildMTSFrom(fsmA, ltsOutput);
		
		MTS<Long, String> mtsB = testUtils.buildMTSFrom(fsmB, ltsOutput);
		...
		if (fsmMergeLowerBound != null) {
			MTS<Long, String> mtsLB = testUtils.buildMTSFrom(fsmMergeLowerBound, ltsOutput);
