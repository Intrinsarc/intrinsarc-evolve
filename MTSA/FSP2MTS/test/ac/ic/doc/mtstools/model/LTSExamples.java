...
public class LTSExamples {
	...
	static {
		...
		LTS_01 = new LTSImpl<Integer,String>(0, "nombre");
		LTS_01.addActions(actions);
		LTS_01.addStates(states);
		LTS_01.addTransition(0,"a",1);		
		
		LTS_04 = new LTSImpl<Integer,String>(0, "nombre");
		...
		LTS_04_B = new LTSImpl<Integer,String>(0, "nombre");
		...
		LTS_WEIRD = new LTSImpl<Integer,String>(0, "nombre");
