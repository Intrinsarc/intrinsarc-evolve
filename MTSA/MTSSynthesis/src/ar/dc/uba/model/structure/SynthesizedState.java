...
/**
 * A state is a tuple. It has the significative suffix and the obligations.
 * 
 * @author gsibay
 * 
 */
public class SynthesizedState {
	...
	public SynthesizedState(Word significativeSuffix, Obligations obligations,
	...
	public String toString() {
		...
		buffer.append("<").append(this.getSignificativeSuffix()).append(";")
				.append(this.getObligations()).append(this.zetaFunction)
				.append(">");
	...
	public boolean equals(Object anObject) {
		...
		if (anObject instanceof SynthesizedState) {
			...
			return (new EqualsBuilder()).append(this.getSignificativeSuffix(),
					state.getSignificativeSuffix()).append(
					this.getObligations(), state.getObligations()).append(
					this.getZetaFunction(), state.getZetaFunction()).isEquals();
		} else {
			return false;
		}
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(17, 39)
				.append(this.getSignificativeSuffix()).append(
						this.getObligations()).append(this.getZetaFunction())
				.toHashCode();
	}
}
