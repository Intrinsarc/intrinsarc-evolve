...
public class ConditionLocation implements Location {
	...
	public ConditionLocation(String conditionName, Set<String> instances,
			Formula formula) {
		Validate.notEmpty(conditionName);
		Validate.notEmpty(instances);
		Validate.notNull(formula);
		this.conditionName = conditionName;
		this.instances = Collections.unmodifiableSet(new HashSet<String>(
				instances));
	...
	public String toString() {
		...
		sBuffer.append(this.getConditionName()).append(this.getInstances());
	...
	public int hashCode() {
		return new HashCodeBuilder(13, 33).append(this.getConditionName())
				.toHashCode();
	}
