...
public abstract class TriggeredScenario {
	...
	public TriggeredScenario(Chart prechart, Chart mainchart,
			Set<Symbol> restricted, Set<Fluent> fluents)
			throws IllegalArgumentException {
		this.prechart = prechart;
		this.mainchart = mainchart;
		this.fluents = Collections.unmodifiableSet(fluents);
		this.alphabet = this.calculateAlphabet(prechart, mainchart, restricted,
				fluents);
	}
	...
	public abstract MTS<SynthesizedState, Symbol> acceptSynthesisVisitor(
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder()
				.append(this.getPrechart(), lsc.getPrechart()).append(
						this.getMainchart(), lsc.getMainchart()).append(
						this.getAlphabet(), lsc.getAlphabet()).append(
						this.getFluents(), lsc.getFluents()).append(
						this.getClass(), lsc.getClass()).isEquals();
	}
	...
	public int hashCode() {
		...
		return new HashCodeBuilder().append(this.getPrechart()).append(
				this.getMainchart()).append(this.getAlphabet()).append(
				this.getFluents()).append(this.getClass()).toHashCode();
	}

	public String toString() {
		StringBuffer buffer = new StringBuffer();
		buffer.append("Fluents: ").append("\n").append(this.getFluents())
				.append("\n");
		buffer.append("Prechart: ").append(this.getPrechart().toString())
				.append("\n");
		buffer.append("Prechart's linearisations: ").append(
				this.getPrechart().getLinearisations().toString()).append("\n");
		buffer.append("Mainchart: ").append(this.getMainchart().toString())
				.append("\n");
		buffer.append("Mainchart's linearisations: ").append(
				this.getMainchart().getLinearisations().toString())
				.append("\n");
		buffer.append("Alphabet: ").append(this.getAlphabet().toString())
				.append("\n");
