...
public class Word {
	...
	/**
	 * Returns a new Word that is equals to this one without the first Symbol.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns true if the word starts with the symbol. If the word is empty
	 * returns false (there is no starting symbol)
	 * 
	 * @param symbol
	 * @return
	 */
	...
	private static class WordToSymbolsTransformer implements
			Transformer<Word, List<Symbol>> {
