...
/**
 * A canonical symbol is a simple symbol and the conditions
 * 
 * @author gsibay
 * 
 */
public class CanonicalSymbol implements Symbol {
	...
	public String toString() {
		...
		buffer.append("Symbol = ").append(this.symbol).append("\n").append(
				"Conditions = ").append(this.conditionsNames);
	...
	public boolean equals(Object anObject) {
		...
		if (anObject instanceof CanonicalSymbol) {
			...
			return new EqualsBuilder().append(this.symbol,
					canonicalSymbol.getSymbol()).append(this.conditionsNames,
					canonicalSymbol.getConditionsNames()).isEquals();
		} else {
			return false;
		}
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(17, 39).append(this.getSymbol()).append(
				this.getConditionsNames()).toHashCode();
	}
}
