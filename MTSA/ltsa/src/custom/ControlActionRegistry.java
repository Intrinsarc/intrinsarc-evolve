...
public class ControlActionRegistry {
	...
	Hashtable actionNumber = new Hashtable(); // maps model action names to menu
	// indices
	...
	public ControlActionRegistry(Relation actionsToControls,
			AnimationMessage msg) {
	...
	protected void initControlMap() {
		...
		while (e.hasMoreElements()) {
			...
			if (actions instanceof String) {
				int ia = ((Integer) actionNumber.get((String) actions))
						.intValue();
				temp = new int[1];
				temp[0] = ia;
				controlMap[ic] = temp;
	...
	protected void initActionMap() {
		...
		while (e.hasMoreElements()) {
			...
			if (controls instanceof String) {
				int ic = ((Integer) controlNumber.get((String) controls))
						.intValue();
				temp = new int[1];
				temp[0] = ic;
				actionMap[ia] = temp;
