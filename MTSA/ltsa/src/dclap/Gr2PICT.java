...
public class Gr2PICT extends java.awt.Graphics {
	...
	public boolean doImage(Image img, int x, int y, int width, int height,
		 ...
		 * os.println("20 dict begin"); emitColorImageProlog(pc.xdim);
		 * 
		 * os.println("% lower left corner"); os.print(x); os.print(" ");
		 * os.print(y); os.println(" translate");
		 * 
		 * // compute image size. First of all, if width or height is 0, image
		 * is 1:1. if (height == 0 || width == 0) { height = pc.ydim; width =
		 * pc.xdim; }
		 * 
		 * os.println("% size of image"); os.print(width); os.print(" ");
		 * os.print(height); os.println(" scale");
		 * 
		 * os.print(pc.xdim); os.print(" "); os.print(pc.ydim);
		 * os.println(" 8");
		 * 
		 ...
		 * os.println("false 3 colorimage"); os.println("");
		 * 
		 * 
		 ...
		 * pc.pix[j][i];
		 * 
		 * // put hex chars into string // flip red for blue, to make postscript
		 * happy.
		 * 
