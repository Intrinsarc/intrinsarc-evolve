...
class RelabelDefn {
	...
	public void makeRelabels(Hashtable constants, Hashtable locals,
			Relation relabels) {
		mkRelabels(constants, locals, relabels);
	}

	private void mkRelabels(Hashtable constants, Hashtable locals,
			Relation relabels) {
		if (range != null) {
	...
	public static Relation getRelabels(Vector relabelDefns,
			Hashtable constants, Hashtable locals) {
