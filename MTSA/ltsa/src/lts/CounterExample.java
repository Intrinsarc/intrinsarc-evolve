...
public class CounterExample {
	...
	public void print(LTSOutput output, boolean checkDeadlocks) {
		...
		int result = EventState.search(trace, mach.composition.states, 0,
				findState, mach.composition.endseq, checkDeadlocks);
		errorTrace = null;
		switch (result) {
		...
		case Declaration.STOP:
			...
			errorTrace = EventState.getPath(trace.path,
					mach.composition.alphabet);
