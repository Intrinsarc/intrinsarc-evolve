...
public interface Animator {
	...
	/**
	 * initialises the Animator with the list of actions that are to be
	 * controlled menu is a vector of strings returns bitset of eligible menu
	 * actions
	 */
	public BitSet initialise(Vector menu);

	/*
	 * returns the alphabet of names from menu that are contained in the model
	 * alphabet indexes in this string array are consistent with the bitsets
	 * returned by the step operations. if menu was null then the complete model
	...
	/**
	 * causes the Animator to take a single step by choosing one of the eligible
	 * menu actions returns a bitset of eligible menu actions
	 */
	...
	/**
	 * return the action number in AllNames of the last action chosen and
	 * executed
	 */
	...
	/**
	 * returns true if priority actions are low priority flase if they are low
	 * priority
	 */
