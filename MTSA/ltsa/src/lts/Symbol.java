...
public class Symbol {
	...
	public Color getColor() {
		if (kind > 0 && kind <= INIT || kind == OPTIMISTIC
				|| kind == PESSIMISTIC || kind == CLOUSURE || kind == ABSTRACT
				|| kind == GOAL || kind == ASSUME || kind == GUARANTEE
				|| kind == SAFETY || kind == CONTROLLER || kind == CONTROLLABLE
				|| kind == FAULT)
			return Color.blue;
