...
public class ControllerDefinition {
	...
	private static Hashtable<String, ControllerDefinition> definitions = new Hashtable<String, ControllerDefinition>();
	...
	public static void put(ControllerDefinition controller) {
		if (definitions.put(controller.getNameString(), controller) != null) {
			Diagnostics.fatal("duplicate Controller definition: "
	...
	public static ControllerDefinition getDefinition(Symbol definitionName) {
		ControllerDefinition definition = definitions.get(definitionName
				.getName());
		if (definition == null) {
