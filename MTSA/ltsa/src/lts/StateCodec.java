...
public class StateCodec {
	 ...
	 * System.out.println("NBYTE: "+c.NBYTE); System.out.print("boundaries: {");
	 * for(int i=0; i<c.boundaries.length;++i)
	 * System.out.print(" "+c.boundaries[i]+","); System.out.println("}"); int
	 * state[] = {999,2,999,0,4,5,6,7,1,999,1,999,999,4,5,6,7,1}; byte code[] =
	 * c.encode(state); int result[] = c.decode(code);
	 * System.out.print("code: {"); for(int i=0; i<code.length;++i)
	 * System.out.print(" "+code[i]+","); System.out.println("}");
	 * System.out.print("result: {"); for(int i=0; i<c.bitSize.length;++i)
