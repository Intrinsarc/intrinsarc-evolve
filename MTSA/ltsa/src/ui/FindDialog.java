...
public abstract class FindDialog extends JDialog {
	...
	public FindDialog(Frame container) {
		...
		ButtonGroup directionButtonGroup = new ButtonGroup(), scopeButtonGroup = new ButtonGroup();
		JPanel inputPanel = new JPanel(), directionPanel = new JPanel(), scopePanel = new JPanel(), optionsPanel = new JPanel(), statusPanel = new JPanel();
		JLabel findLabel = new JLabel("Find:"), replaceLabel = new JLabel(
				"Replace With:");
		GridBagLayout layout = new GridBagLayout(), inputLayout = new GridBagLayout(), statusLayout = new GridBagLayout();
		...
		findButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int startIndex = findNext(t.getText(), t.getCaret(), findField
						.getText(), matchCaseCheckBox.isSelected(),
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (t.getSelectedText() == null)
					;
						...
						|| t.getSelectedText().equalsIgnoreCase(
								findField.getText())) {
		...
		int w = Math.max(directionPanel.getPreferredSize().width, scopePanel
				.getPreferredSize().width), h = Math.max(directionPanel
