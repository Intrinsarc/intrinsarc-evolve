 ...
 * @param <E2>
 */
public class UniversalBinaryRelation<E1, E2> extends AbstractSet<Pair<E1, E2>>
		implements BinaryRelation<E1, E2> {

	private Set<E1> col1;
	private Set<E2> col2;

	public UniversalBinaryRelation(Set<? extends E1> col1,
			Set<? extends E2> col2) {
	...
	public boolean contains(Object o) {
		...
		Pair pair = (Pair) o;
		return this.col1.contains(pair.getFirst())
				&& this.col2.contains(pair.getSecond());
	}
